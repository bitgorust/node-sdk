# Feishu API Scope Index

- APIs: 1432
- APIs with required scopes: 1421
- APIs with field scopes: 486
- Distinct scope names: 949
...
- DELETE /open-apis/apaas/v1/applications/:namespace/objects/:object_api_name/records/:id | 删除记录
  ...
  field: (none)
  all: app_engine:object.record:write
  tokens: tenant_access_token
...
- DELETE /open-apis/apaas/v1/workspaces/:workspace_id/tables/:table_name/records | 删除数据表中的记录
  ...
  field: (none)
  all: app_engine:workspace.table.record:write
  tokens: user_access_token
- DELETE /open-apis/approval/v4/instances/:instance_id/comments/:comment_id | 删除评论
  ...
  field: contact:user.employee_id:readonly
  all: approval:approval, approval:instance.comment, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- DELETE /open-apis/bitable/v1/apps/:app_token/roles/:role_id | 删除自定义角色
  ...
  field: (none)
  all: base:role:delete, bitable:app
  tokens: tenant_access_token, user_access_token
...
- DELETE /open-apis/calendar/v4/calendars/:calendar_id/acls/:acl_id | 删除访问控制
  ...
  field: (none)
  all: calendar:calendar, calendar:calendar.acl:delete
  tokens: tenant_access_token, user_access_token
- DELETE /open-apis/calendar/v4/calendars/:calendar_id/events/:event_id | 删除日程
  ...
  field: (none)
  all: calendar:calendar, calendar:calendar.event:delete, calendar:calendar.event:writeonly
  tokens: tenant_access_token, user_access_token
- DELETE /open-apis/calendar/v4/calendars/:calendar_id/events/:event_id/meeting_chat | 解绑会议群
  ...
  field: (none)
  all: calendar:calendar, calendar:calendar.event:update
  tokens: tenant_access_token, user_access_token
...
- DELETE /open-apis/contact/v3/users/:user_id | 删除用户
  required: contact:contact
  field: contact:user.employee_id:readonly
  all: contact:contact, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- DELETE /open-apis/corehr/v1/departments/:department_id | 删除部门
  ...
  field: (none)
  all: corehr:corehr, corehr:department:write
  tokens: tenant_access_token
...
- DELETE /open-apis/corehr/v2/employees/additional_jobs/:additional_job_id | 删除兼职
  ...
  field: (none)
  all: corehr:additional_job:write
  tokens: tenant_access_token
...
- DELETE /open-apis/directory/v1/collaboration_rules/:collaboration_rule_id | 删除可搜可见规则
  ...
  field: (none)
  all: trust_party:collaboration_rule:write
  tokens: tenant_access_token, user_access_token
- DELETE /open-apis/directory/v1/departments/:department_id | 删除部门
  ...
  field: (none)
  all: directory:department.delete:write, directory:department:write
  tokens: tenant_access_token, user_access_token
- DELETE /open-apis/directory/v1/employees/:employee_id | 离职员工
  ...
  field: (none)
  all: directory:employee.resign:write, directory:employee:write
  tokens: tenant_access_token, user_access_token
- DELETE /open-apis/docx/v1/chats/:chat_id/announcement/blocks/:block_id/children/batch_delete | 删除群公告中的块
  ...
  field: (none)
  all: im:chat.announcement:write_only
  tokens: tenant_access_token, user_access_token
...
- DELETE /open-apis/drive/v1/permissions/:token/members/:member_id | 移除云文档协作者权限
  ...
  field: (none)
  all: bitable:app, bitable:bitable, docs:doc, docs:permission.member:delete, drive:drive, drive:file, sheets:spreadsheet, wiki:wiki
  tokens: tenant_access_token, user_access_token
- DELETE /open-apis/drive/v1/permissions/:token/public/password | 停用云文档密码
  ...
  field: (none)
  all: bitable:bitable, docs:doc, docs:permission.setting:write_only, drive:drive, sheets:spreadsheet, wiki:wiki
  tokens: tenant_access_token, user_access_token
- DELETE /open-apis/drive/v1/user/remove_subscription | 取消用户云文档事件订阅
  required: docs:event:subscribe
  field: (none)
  all: docs:event:subscribe
  tokens: tenant_access_token, user_access_token
...
- DELETE /open-apis/mail/v1/user_mailboxes/:user_mailbox_id/folders/:folder_id | 删除邮箱文件夹
  ...
  field: (none)
  all: mail:user_mailbox.folder:write
  tokens: tenant_access_token, user_access_token
...
- DELETE /open-apis/performance/v2/additional_informations/batch | 批量删除补充信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, performance:performance, performance:semester_activity:write
  tokens: tenant_access_token
...
- DELETE /open-apis/search/v2/data_sources/:data_source_id/items/:item_id | 删除数据项
  ...
  field: (none)
  all: search:data_item:delete, search:data_source
  tokens: tenant_access_token
- DELETE /open-apis/search/v2/schemas/:schema_id | 删除数据范式
  ...
  field: (none)
  all: search:data_schemas:delete, search:data_source, search:data_source:readonly
  tokens: tenant_access_token
- DELETE /open-apis/security_and_compliance/v2/device_records/:device_record_id | 删除设备
  ...
  field: (none)
  all: security_and_compliance:device_record:write
  tokens: tenant_access_token
- DELETE /open-apis/sheets/v3/spreadsheets/:spreadsheet_token/sheets/:sheet_id/filter | 删除筛选
  ...
  field: (none)
  all: drive:drive, sheets:spreadsheet, sheets:spreadsheet:write_only
  tokens: tenant_access_token, user_access_token
...
- DELETE /open-apis/task/v2/tasks/:task_guid | 删除任务
  ...
  field: (none)
  all: task:task:delete, task:task:write
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/acs/v1/devices | 获取门禁设备列表
  ...
  field: (none)
  all: acs:devices:readonly
  tokens: tenant_access_token
- GET /open-apis/acs/v1/rule_external | 获取权限组信息
  required: acs:devices:readonly, acs:users
  field: contact:user.employee_id:readonly
  all: acs:devices:readonly, acs:users, contact:user.employee_id:readonly
  tokens: user_access_token
...
- GET /open-apis/admin/v1/badges/:badge_id/grants | 获取授予名单列表
  required: admin:badge.grant
  field: contact:user.employee_id:readonly
  all: admin:badge.grant, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- GET /open-apis/apaas/v1/applications/:namespace/audit_log | 查询审计日志详情
  ...
  field: (none)
  all: app_engine:security.audit_log:read
  tokens: user_access_token
...
- GET /open-apis/apaas/v1/workspaces/:workspace_id/enums | 获取工作空间下的自定义枚举列表
  ...
  field: (none)
  all: app_engine:workspace.table:read, app_engine:workspace.table:write
  tokens: user_access_token
...
- GET /open-apis/apaas/v1/workspaces/:workspace_id/tables/:table_name/records | 查询数据表数据记录
  ...
  field: (none)
  all: app_engine:workspace.table.record:read, app_engine:workspace.table.record:write
  tokens: user_access_token
...
- GET /open-apis/application/v6/app_recommend_rules | 获取当前设置的推荐规则列表
  ...
  field: contact:user.employee_id:readonly
  all: application:app_recommend_rule:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- GET /open-apis/application/v6/applications/:app_id | 获取应用信息
  ...
  field: contact:user.employee_id:readonly
  all: admin:app.info:readonly, application:application:self_manage, contact:user.employee_id:readonly
  tokens: tenant_access_token
- GET /open-apis/application/v6/applications/:app_id/app_versions | 获取应用版本列表
  ...
  field: contact:user.employee_id:readonly
  all: application:application.app_version:readonly, application:application:self_manage, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- GET /open-apis/application/v6/applications/:app_id/contacts_range_configuration | 获取应用通讯录权限范围配置
  required: admin:app.info:readonly
  field: contact:user.employee_id:readonly
  all: admin:app.info:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token
- GET /open-apis/application/v6/applications/:app_id/feedbacks | 获取应用反馈列表
  ...
  field: contact:user.email:readonly, contact:user.employee_id:readonly, contact:user.phone:readonly, directory:employee.base.email:read
  all: application:application.feedback.feedback_info, contact:user.email:readonly, contact:user.employee_id:readonly, contact:user.phone:readonly, directory:employee.base.email:read
  tokens: tenant_access_token
...
- GET /open-apis/approval/v4/approvals/:approval_id | 查看指定审批定义
  ...
  field: contact:user.employee_id:readonly
  all: approval:approval, approval:approval:readonly, approval:definition, contact:user.employee_id:readonly
  tokens: tenant_access_token
- GET /open-apis/approval/v4/districts | 查询地理库信息
  required: approval:approval, approval:approval:readonly
  field: (none)
  all: approval:approval, approval:approval:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/approval/v4/external_approvals/:approval_code | 查看指定三方审批定义
  ...
  field: contact:user.employee_id:readonly
  all: approval:approval, approval:external_approval, contact:user.employee_id:readonly
  tokens: tenant_access_token
- GET /open-apis/approval/v4/external_tasks | 获取三方审批任务状态
  ...
  field: (none)
  all: approval:approval, approval:approval:readonly, approval:external_task
  tokens: tenant_access_token
- GET /open-apis/approval/v4/instances | 批量获取审批实例 ID
  required: approval:approval, approval:approval:readonly, approval:instance
  field: (none)
  all: approval:approval, approval:approval:readonly, approval:instance
  tokens: tenant_access_token
- GET /open-apis/approval/v4/instances/:instance_id | 获取单个审批实例详情
  required: approval:approval, approval:approval:readonly, approval:instance
  field: contact:user.employee_id:readonly
  all: approval:approval, approval:approval:readonly, approval:instance, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- GET /open-apis/attendance/v1/leave_employ_expire_records/:leave_id | 通过过期时间获取发放记录
  required: attendance:rule
  field: contact:user.employee_id:readonly
  all: attendance:rule, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- GET /open-apis/attendance/v1/user_flows/:user_flow_id | 查询打卡流水
  ...
  field: (none)
  all: attendance:task, attendance:task:readonly
  tokens: tenant_access_token
...
- GET /open-apis/authen/v1/user_info | 获取用户信息
  required: (none)
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.phone:readonly, directory:employee.base.email:read
  all: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.phone:readonly, directory:employee.base.email:read
  tokens: user_access_token
- GET /open-apis/baike/v1/classifications | 获取词典分类
  required: baike:entity, baike:entity:exempt_review, baike:entity:readonly
  field: (none)
  all: baike:entity, baike:entity:exempt_review, baike:entity:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/baike/v1/entities | 获取词条列表
  required: baike:entity, baike:entity:exempt_review, baike:entity:readonly
  field: contact:user.employee_id:readonly
  all: baike:entity, baike:entity:exempt_review, baike:entity:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/bitable/v1/apps/:app_token/roles/:role_id/members | 列出协作者
  ...
  field: (none)
  all: base:collaborator:read, bitable:app, bitable:app:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/bitable/v1/apps/:app_token/tables | 列出数据表
  required: base:table:read, bitable:app, bitable:app:readonly
  field: (none)
  all: base:table:read, bitable:app, bitable:app:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/bitable/v1/apps/:app_token/tables/:table_id/fields | 列出字段
  ...
  field: (none)
  all: base:field:read, bitable:app, bitable:app:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/bitable/v1/apps/:app_token/tables/:table_id/forms/:form_id | 获取表单元数据
  ...
  field: (none)
  all: base:form:read, bitable:app, bitable:app:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/calendar/v4/calendars | 查询日历列表
  ...
  field: (none)
  all: calendar:calendar, calendar:calendar.calendar:readonly, calendar:calendar:read, calendar:calendar:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/calendar/v4/calendars/:calendar_id | 查询日历信息
  ...
  field: (none)
  all: calendar:calendar, calendar:calendar:read, calendar:calendar:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/calendar/v4/calendars/:calendar_id/acls | 获取访问控制列表
  ...
  field: contact:user.employee_id:readonly
  all: calendar:calendar, calendar:calendar.acl:read, calendar:calendar:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/calendar/v4/calendars/:calendar_id/events | 获取日程列表
  ...
  field: contact:user.employee_id:readonly
  all: calendar:calendar, calendar:calendar.event:read, calendar:calendar:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/calendar/v4/calendars/:calendar_id/events/:event_id/instances | 获取重复日程实例
  required: calendar:calendar, calendar:calendar.event:read, calendar:calendar:readonly
  field: (none)
  all: calendar:calendar, calendar:calendar.event:read, calendar:calendar:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/contact/v3/departments/:department_id | 获取单个部门信息
  ...
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:department.base:readonly, contact:department.hrbp:readonly, contact:department.organize:readonly, contact:user.employee_id:readonly
  all: contact:contact.base:readonly, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:department.base:readonly, contact:department.hrbp:readonly, contact:department.organize:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/contact/v3/employee_type_enums | 查询人员类型
  ...
  field: (none)
  all: contact:contact.base:readonly, contact:contact:access_as_app, contact:contact:readonly_as_app
  tokens: tenant_access_token
- GET /open-apis/contact/v3/functional_roles/:role_id/members | 查询角色下的所有成员信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:functional_role, contact:functional_role:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- GET /open-apis/contact/v3/group/:group_id | 查询指定用户组
  ...
  field: contact:user.employee_id:readonly
  all: contact:group:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token
- GET /open-apis/contact/v3/group/:group_id/member/simplelist | 查询用户组成员列表
  required: contact:group:readonly
  field: (none)
  all: contact:group:readonly
  tokens: tenant_access_token
...
- GET /open-apis/contact/v3/job_families | 获取租户序列列表
  ...
  field: (none)
  all: contact:contact:readonly_as_app, contact:job_family, contact:job_family:readonly
  tokens: tenant_access_token
...
- GET /open-apis/contact/v3/job_levels | 获取租户职级列表
  ...
  field: (none)
  all: contact:contact:readonly_as_app, contact:job_level, contact:job_level:readonly
  tokens: tenant_access_token
...
- GET /open-apis/contact/v3/job_titles | 获取租户职务列表
  ...
  field: (none)
  all: contact:contact:access_as_user, contact:contact:readonly_as_app, contact:job_title:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/contact/v3/scopes | 获取通讯录授权范围
  required: contact:contact.base:readonly, contact:contact:access_as_app, contact:contact:readonly_as_app
  field: contact:user.employee_id:readonly
  all: contact:contact.base:readonly, contact:contact:access_as_app, contact:contact:readonly_as_app, contact:user.employee_id:readonly
  tokens: tenant_access_token
- GET /open-apis/contact/v3/unit | 获取单位列表
  required: contact:unit:readonly
  field: (none)
  all: contact:unit:readonly
  tokens: tenant_access_token
...
- GET /open-apis/contact/v3/users/:user_id | 获取单个用户信息
  required: contact:contact.base:readonly, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.assign_info:read, contact:user.base:readonly, contact:user.department:readonly, contact:user.department_path:readonly, contact:user.dotted_line_leader_info.read, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.employee_number:read, contact:user.gender:readonly, contact:user.job_family:readonly, contact:user.job_level:readonly, contact:user.phone:readonly, contact:user.union_id:readonly, contact:user.user_geo, directory:employee.base.email:read
  all: contact:contact.base:readonly, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.assign_info:read, contact:user.base:readonly, contact:user.department:readonly, contact:user.department_path:readonly, contact:user.dotted_line_leader_info.read, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.employee_number:read, contact:user.gender:readonly, contact:user.job_family:readonly, contact:user.job_level:readonly, contact:user.phone:readonly, contact:user.union_id:readonly, contact:user.user_geo, directory:employee.base.email:read
  tokens: tenant_access_token, user_access_token
- GET /open-apis/contact/v3/users/batch | 批量获取用户信息
  required: contact:contact.base:readonly
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.assign_info:read, contact:user.base:readonly, contact:user.department:readonly, contact:user.department_path:readonly, contact:user.dotted_line_leader_info.read, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.employee_number:read, contact:user.gender:readonly, contact:user.job_family:readonly, contact:user.job_level:readonly, contact:user.phone:readonly, contact:user.subscription_ids:write, contact:user.union_id:readonly, contact:user.user_geo, directory:employee.base.email:read
  all: contact:contact.base:readonly, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.assign_info:read, contact:user.base:readonly, contact:user.department:readonly, contact:user.department_path:readonly, contact:user.dotted_line_leader_info.read, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.employee_number:read, contact:user.gender:readonly, contact:user.job_family:readonly, contact:user.job_level:readonly, contact:user.phone:readonly, contact:user.subscription_ids:write, contact:user.union_id:readonly, contact:user.user_geo, directory:employee.base.email:read
  tokens: tenant_access_token, user_access_token
- GET /open-apis/contact/v3/users/find_by_department | 获取部门直属用户列表
  required: contact:contact.base:readonly, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:department.organize:readonly
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly, contact:user.department:readonly, contact:user.department_path:readonly, contact:user.dotted_line_leader_info.read, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.employee_number:read, contact:user.gender:readonly, contact:user.job_family:readonly, contact:user.job_level:readonly, contact:user.phone:readonly, contact:user.union_id:readonly, contact:user.user_geo, directory:employee.base.email:read
  all: contact:contact.base:readonly, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:department.organize:readonly, contact:user.base:readonly, contact:user.department:readonly, contact:user.department_path:readonly, contact:user.dotted_line_leader_info.read, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.employee_number:read, contact:user.gender:readonly, contact:user.job_family:readonly, contact:user.job_level:readonly, contact:user.phone:readonly, contact:user.union_id:readonly, contact:user.user_geo, directory:employee.base.email:read
  tokens: tenant_access_token, user_access_token
- GET /open-apis/contact/v3/work_cities | 获取租户工作城市列表
  ...
  field: (none)
  all: contact:contact:access_as_user, contact:contact:readonly_as_app, contact:work_city:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/corehr/v1/authorizations/get_by_param | 查询单个用户授权
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:authorization:write, corehr:corehr, corehr:corehr:readonly
  tokens: tenant_access_token
- GET /open-apis/corehr/v1/authorizations/query | 批量查询用户授权
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:authorization:read, corehr:authorization:write, corehr:corehr, corehr:corehr:readonly
  tokens: tenant_access_token
- GET /open-apis/corehr/v1/companies | 批量查询公司
  required: corehr:company:read, corehr:corehr, corehr:corehr:readonly
  field: (none)
  all: corehr:company:read, corehr:corehr, corehr:corehr:readonly
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/compensation_standards/match | 获取员工薪资标准
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:compensation_standards:read
  tokens: tenant_access_token, user_access_token
- GET /open-apis/corehr/v1/contracts | 批量查询合同
  required: corehr:corehr, corehr:corehr:readonly
  field: (none)
  all: corehr:corehr, corehr:corehr:readonly
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/country_regions | 批量查询国家/地区信息
  ...
  field: (none)
  all: corehr:common_data.basic_data:read, corehr:corehr, corehr:corehr:readonly
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/custom_fields/get_by_param | 获取字段详情
  ...
  field: (none)
  all: corehr:common_data.meta_data:read, corehr:corehr, corehr:corehr:readonly
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/departments | 批量查询部门
  required: corehr:corehr, corehr:corehr:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:corehr, corehr:corehr:readonly
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/employee_types | 批量查询人员类型
  ...
  field: (none)
  all: corehr:common_data.preset_data:read, corehr:common_data.preset_data:write, corehr:corehr, corehr:corehr:readonly
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/files/:id | 下载文件
  ...
  field: (none)
  all: corehr:file:read, corehr:file:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v1/job_families | 批量查询序列
  ...
  field: (none)
  all: corehr:corehr, corehr:corehr:readonly, corehr:job_family:read, corehr:job_family:write
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/job_levels | 批量查询职级
  ...
  field: (none)
  all: corehr:corehr, corehr:corehr:readonly, corehr:job_level:read, corehr:job_level:write
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/jobs | 批量查询职务
  ...
  field: (none)
  all: corehr:corehr, corehr:corehr:readonly, corehr:job:read, corehr:job:write
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/leaves/calendar_by_scope | 根据适用条件获取工作日历 ID
  ...
  field: (none)
  all: corehr:corehr:readonly, corehr:leave:read, corehr:work_calendar:read
  tokens: tenant_access_token, user_access_token
- GET /open-apis/corehr/v1/leaves/leave_balances | 批量查询员工假期余额
  required: corehr:corehr, corehr:corehr:readonly, corehr:leave:read
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:corehr, corehr:corehr:readonly, corehr:leave:read
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/leaves/leave_types | 获取假期类型列表
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:common_data.preset_data:read, corehr:corehr, corehr:corehr:readonly, corehr:leave:read
  tokens: tenant_access_token
- GET /open-apis/corehr/v1/locations | 批量分页查询地点信息
  ...
  field: (none)
  all: corehr:corehr, corehr:corehr:readonly, corehr:locations:read, corehr:locations:write
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/persons/:person_id | 查询单个个人信息
  ...
  field: (none)
  all: corehr:corehr, corehr:corehr:readonly, corehr:person:read, corehr:person:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v1/pre_hires | 批量查询待入职信息
  ...
  field: (none)
  all: corehr:corehr, corehr:corehr:readonly, corehr:pre_hire:read, corehr:pre_hire:write
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/processes/:process_id/form_variable_data | 获取流程表单数据
  ...
  field: (none)
  all: corehr:corehr, corehr:corehr:readonly, corehr:process:read
  tokens: tenant_access_token
- GET /open-apis/corehr/v1/security_groups | 批量获取角色列表
  required: corehr:corehr, corehr:corehr:readonly, corehr:security_group:read
  field: (none)
  all: corehr:corehr, corehr:corehr:readonly, corehr:security_group:read
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v1/transfer_reasons/query | 获取异动原因列表
  ...
  field: (none)
  all: corehr:common_data.preset_data:read, corehr:common_data.preset_data:write, corehr:corehr, corehr:corehr:readonly, corehr:transfer_reason:read
  tokens: tenant_access_token
- GET /open-apis/corehr/v1/transfer_types/query | 获取异动类型列表
  ...
  field: (none)
  all: corehr:common_data.preset_data:read, corehr:common_data.preset_data:write, corehr:corehr, corehr:corehr:readonly, corehr:transfer_type:readonly
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v2/cost_centers/query_recent_change | 查询当前生效信息发生变更的成本中心
  ...
  field: (none)
  all: corehr:cost_center:read, corehr:cost_center:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/custom_org/employment_custom_org_record | 批量查询人员自定义组织变更记录
  ...
  field: contact:user.employee_id:readonly, corehr:employment.custom_org_field:read, corehr:employment.custom_org_field:write
  all: contact:user.employee_id:readonly, corehr:employment.custom_org:read, corehr:employment.custom_org:write, corehr:employment.custom_org_field:read, corehr:employment.custom_org_field:write
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v2/custom_orgs/query_recent_change | 查询当前生效信息变更的自定义组织
  ...
  field: (none)
  all: corehr:custom_org:read, corehr:custom_org:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/departments/query_recent_change | 查询生效信息变更部门
  ...
  field: (none)
  all: corehr:department:read, corehr:department:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/drafts/:draft_id | 根据组织架构调整 ID 查询发起的流程信息
  required: corehr:draft:read
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:draft:read
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/employees/international_assignments | 批量查询外派信息
  ...
  field: contact:user.employee_id:readonly, corehr:employment.international_assignment.compensation_type:read, corehr:employment.international_assignment.compensation_type:write, corehr:employment.international_assignment.custom_field:read, corehr:employment.international_assignment.custom_field:write, corehr:employment.international_assignment.job:read, corehr:employment.international_assignment.job:write, corehr:employment.international_assignment.job_grade:read, corehr:employment.international_assignment.job_grade:write, corehr:employment.international_assignment.job_level:read, corehr:employment.international_assignment.job_level:write, corehr:employment.international_assignment.position:read, corehr:employment.international_assignment.position:write, corehr:employment.international_assignment.service_company:read, corehr:employment.international_assignment.service_company:write, corehr:employment.international_assignment.weekly_working_hours:read, corehr:employment.international_assignment.weekly_working_hours:write, corehr:employment.international_assignment.work_calendar:read, corehr:employment.international_assignment.work_calendar:write, corehr:employment.international_assignment.work_location:read, corehr:employment.international_assignment.work_location:write, corehr:employment.international_assignment.work_shift:read, corehr:employment.international_assignment.work_shift:write, corehr:employment.international_assignment.working_hours_type:read, corehr:employment.international_assignment.working_hours_type:write
  all: contact:user.employee_id:readonly, corehr:employees.international_assignment:read, corehr:employees.international_assignment:write, corehr:employment.international_assignment.compensation_type:read, corehr:employment.international_assignment.compensation_type:write, corehr:employment.international_assignment.custom_field:read, corehr:employment.international_assignment.custom_field:write, corehr:employment.international_assignment.job:read, corehr:employment.international_assignment.job:write, corehr:employment.international_assignment.job_grade:read, corehr:employment.international_assignment.job_grade:write, corehr:employment.international_assignment.job_level:read, corehr:employment.international_assignment.job_level:write, corehr:employment.international_assignment.position:read, corehr:employment.international_assignment.position:write, corehr:employment.international_assignment.service_company:read, corehr:employment.international_assignment.service_company:write, corehr:employment.international_assignment.weekly_working_hours:read, corehr:employment.international_assignment.weekly_working_hours:write, corehr:employment.international_assignment.work_calendar:read, corehr:employment.international_assignment.work_calendar:write, corehr:employment.international_assignment.work_location:read, corehr:employment.international_assignment.work_location:write, corehr:employment.international_assignment.work_shift:read, corehr:employment.international_assignment.work_shift:write, corehr:employment.international_assignment.working_hours_type:read, corehr:employment.international_assignment.working_hours_type:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/job_families/query_recent_change | 查询当前生效信息发生变更的序列
  ...
  field: (none)
  all: corehr:job_family:read, corehr:job_family:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/job_grades/query_recent_change | 查询当前生效信息发生变更的职等
  ...
  field: (none)
  all: corehr:job_grade:read, corehr:job_grade:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/job_levels/query_recent_change | 查询当前生效信息发生变更的职级
  ...
  field: (none)
  all: corehr:job_level:read, corehr:job_level:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/jobs | 批量查询职务
  ...
  field: corehr:job.job_level:read
  all: corehr:corehr, corehr:corehr:readonly, corehr:job.job_level:read, corehr:job.only:read, corehr:job:read, corehr:job:write
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v2/jobs/query_recent_change | 查询当前生效信息发生变更的职务
  ...
  field: (none)
  all: corehr:job:read, corehr:job:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/locations/query_recent_change | 查询当前生效信息发生变更的地点
  ...
  field: (none)
  all: corehr:locations:read, corehr:locations:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/positions/query_recent_change | 查询指定时范围内当前版本信息发生变更的岗位
  ...
  field: (none)
  all: corehr:position:read, corehr:position:write
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/processes | 查询流程实例列表
  required: corehr:process:read
  field: (none)
  all: corehr:process:read
  tokens: tenant_access_token
...
- GET /open-apis/corehr/v2/signature_files | 获取电子签文件列表
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:signature_file.pre_hire:read, corehr:signature_file:read
  tokens: tenant_access_token
- GET /open-apis/corehr/v2/signature_files/list_by_biz_id | 根据流程获取电子签文件信息
  required: corehr:signature.file:read
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:signature.file:read
  tokens: tenant_access_token
...
- GET /open-apis/drive/export_tasks/file/:file_token/download | 下载导出文件
  ...
  field: (none)
  all: docs:document:export, drive:export:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/drive/v1/files | 获取文件夹中的文件清单
  required: drive:drive, drive:drive:readonly, space:document:retrieve
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, drive:drive, drive:drive:readonly, space:document:retrieve
  tokens: tenant_access_token, user_access_token
- GET /open-apis/drive/v1/files/:file_token/download | 下载文件
  ...
  field: (none)
  all: drive:drive, drive:drive:readonly, drive:file, drive:file:download, drive:file:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/drive/v1/files/:file_token/statistics | 获取文件统计信息
  ...
  field: (none)
  all: drive:drive, drive:drive.metadata:readonly, drive:drive:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/drive/v1/files/:file_token/subscriptions/:subscription_id | 获取订阅状态
  ...
  field: (none)
  all: docs:document.subscription:read, drive:drive, drive:drive:readonly
  tokens: user_access_token
- GET /open-apis/drive/v1/files/:file_token/versions | 获取文档版本列表
  required: drive:drive:version, drive:drive:version:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, drive:drive:version, drive:drive:version:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/drive/v1/files/:file_token/view_records | 获取文件访问记录
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.base:readonly, contact:user.employee_id:readonly, drive:file:view_record:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/drive/v1/import_tasks/:ticket | 查询导入任务结果
  ...
  field: (none)
  all: docs:document:import, drive:drive, drive:drive:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/drive/v1/medias/:file_token/download | 下载素材
  ...
  field: (none)
  all: bitable:app, bitable:app:readonly, docs:doc, docs:doc:readonly, docs:document.media:download, drive:drive, drive:drive:readonly, moments:moments, moments:moments:readonly, sheets:spreadsheet, sheets:spreadsheet:readonly, vc:material, vc:material:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/drive/v1/permissions/:token/members | 获取云文档协作者
  ...
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly
  all: bitable:app, bitable:bitable, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly, docs:doc, docs:permission.member:retrieve, drive:drive, sheets:spreadsheet, wiki:wiki
  tokens: tenant_access_token, user_access_token
- GET /open-apis/drive/v1/permissions/:token/members/auth | 判断用户云文档权限
  ...
  field: (none)
  all: bitable:app, bitable:bitable, docs:doc, docs:permission.member:auth, drive:drive, sheets:spreadsheet, wiki:wiki
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/drive/v2/files/:file_token/likes | 获取云文档的点赞者列表
  ...
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly, contact:user.employee_id:readonly
  all: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly, contact:user.employee_id:readonly, drive:file.like:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/drive/v2/permissions/:token/public | 获取云文档权限设置
  ...
  field: (none)
  all: bitable:bitable, docs:doc, docs:permission.setting:read, docx:document, drive:drive, drive:drive:readonly, drive:file, sheets:spreadsheet, wiki:wiki
  tokens: tenant_access_token, user_access_token
- GET /open-apis/ehr/v1/attachments/:token | 下载人员的附件
  required: ehr:attachment:readonly
  field: (none)
  all: ehr:attachment:readonly
  tokens: tenant_access_token
- GET /open-apis/ehr/v1/employees | 批量获取员工花名册信息
  required: ehr:employee:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, ehr:employee:readonly
  tokens: tenant_access_token
...
- GET /open-apis/helpdesk/v1/notifications/:notification_id | 查询推送
  required: helpdesk:all:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, helpdesk:all:readonly
  tokens: user_access_token
...
- GET /open-apis/hire/v1/agencies/:agency_id | 获取猎头供应商信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:agency, hire:agency:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/applications | 获取投递列表
  ...
  field: (none)
  all: hire:application, hire:application:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/applications/:application_id | 获取投递信息
  required: hire:application, hire:application:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:application, hire:application:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/applications/:application_id/get_detail | 获取投递详情
  required: hire:application, hire:application:readonly
  field: contact:user.employee_id:readonly, hire:agency, hire:agency:readonly, hire:agency_salary:readonly, hire:employee, hire:employee:readonly, hire:evaluation:readonly, hire:interview, hire:interview:readonly, hire:job, hire:job:readonly, hire:offer, hire:offer:readonly, hire:offer_salary:readonly, hire:referral, hire:referral:readonly, hire:site, hire:site:readonly, hire:talent, hire:talent:readonly
  all: contact:user.employee_id:readonly, hire:agency, hire:agency:readonly, hire:agency_salary:readonly, hire:application, hire:application:readonly, hire:employee, hire:employee:readonly, hire:evaluation:readonly, hire:interview, hire:interview:readonly, hire:job, hire:job:readonly, hire:offer, hire:offer:readonly, hire:offer_salary:readonly, hire:referral, hire:referral:readonly, hire:site, hire:site:readonly, hire:talent, hire:talent:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/attachments/:attachment_id | 获取附件信息
  ...
  field: (none)
  all: hire:attachment, hire:attachment:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/background_check_orders | 获取背调信息列表
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:background_check_order, hire:background_check_order:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/evaluation_tasks | 获取简历评估任务列表
  required: hire:evaluation:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:evaluation:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/exam_marking_tasks | 获取笔试阅卷任务列表
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:exam:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/interview_records | 批量获取面试评价详细信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:interview, hire:interview:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/interview_records/attachments | 获取面试记录附件
  required: hire:interview, hire:interview:readonly
  field: (none)
  all: hire:interview, hire:interview:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/interview_tasks | 获取面试任务列表
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:interview:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/interviewers | 查询面试官信息列表
  required: hire:interviewer, hire:interviewer:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:interviewer, hire:interviewer:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/jobs | 获取职位列表
  required: hire:job:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:job:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/jobs/:job_id/get_detail | 获取职位详情
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:job.composite_info:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/notes | 获取备注列表
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:note, hire:note:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/offer_application_forms | 获取 Offer 申请表列表
  ...
  field: (none)
  all: hire:offer_schema:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/offers | 获取 Offer 列表
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:offer, hire:offer:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/offers/:offer_id | 获取 Offer 详情
  ...
  field: contact:user.employee_id:readonly, hire:offer, hire:offer:readonly
  all: contact:user.employee_id:readonly, hire:offer, hire:offer:low_sensitive_info:readonly, hire:offer:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/portal_apply_schemas | 获取申请表模板列表
  required: hire:site, hire:site:readonly
  field: (none)
  all: hire:site, hire:site:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/hire/v1/questionnaires | 获取面试满意度问卷列表
  required: hire:questionnaire, hire:questionnaire:readonly
  field: (none)
  all: hire:questionnaire, hire:questionnaire:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/referral_account/get_account_assets | 查询内推账户
  ...
  field: contact:user.employee_id:readonly, hire:employee.email:readonly, hire:employee.mobile:readonly
  all: contact:user.employee_id:readonly, hire:employee.email:readonly, hire:employee.mobile:readonly, hire:referral_account, hire:referral_account:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/referral_websites/job_posts | 获取内推官网下职位广告列表
  required: hire:referral_website:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:referral_website:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/referrals/get_by_application | 获取内推信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:referral, hire:referral:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/registration_schemas | 获取信息登记表列表
  required: hire:talent, hire:talent:readonly
  field: (none)
  all: hire:talent, hire:talent:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/roles | 获取角色列表
  ...
  field: (none)
  all: hire:auth, hire:auth:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/subjects | 获取项目列表
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:subject:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/talent_folders | 获取人才文件夹列表
  required: hire:talent_folder, hire:talent_folder:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:talent_folder, hire:talent_folder:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/talent_pools | 获取人才库列表
  required: hire:talent_folder, hire:talent_folder:readonly
  field: (none)
  all: hire:talent_folder, hire:talent_folder:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/talent_tags | 获取人才标签信息列表
  required: hire:talent_tag, hire:talent_tag:readonly
  field: (none)
  all: hire:talent_tag, hire:talent_tag:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/talents | 获取人才列表
  required: hire:talent, hire:talent:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:talent, hire:talent:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/todos | 批量获取待办事项
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:todo:readonly
  tokens: user_access_token
- GET /open-apis/hire/v1/tripartite_agreements | 获取三方协议
  required: hire:tripartite_agreement, hire:tripartite_agreement:readonly
  field: (none)
  all: hire:tripartite_agreement, hire:tripartite_agreement:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/user_roles | 获取用户角色列表
  required: hire:auth, hire:auth:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:auth, hire:auth:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v1/websites/:website_id/delivery_tasks/:delivery_task_id | 获取招聘官网投递任务结果
  ...
  field: (none)
  all: hire:site_application, hire:site_application:readonly
  tokens: tenant_access_token
- GET /open-apis/hire/v1/websites/:website_id/job_posts | 获取招聘官网下的职位广告列表
  required: hire:site_job_post:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:site_job_post:readonly
  tokens: tenant_access_token
...
- GET /open-apis/hire/v2/talents/:talent_id | 获取人才详情
  required: hire:talent, hire:talent:readonly
  field: contact:user.employee_id:readonly, hire:note, hire:note:readonly, hire:talent_blocklist, hire:talent_blocklist:readonly, hire:talent_folder, hire:talent_folder:readonly, hire:talent_tag, hire:talent_tag:readonly
  all: contact:user.employee_id:readonly, hire:note, hire:note:readonly, hire:talent, hire:talent:readonly, hire:talent_blocklist, hire:talent_blocklist:readonly, hire:talent_folder, hire:talent_folder:readonly, hire:talent_tag, hire:talent_tag:readonly
  tokens: tenant_access_token
...
- GET /open-apis/mail/v1/mailgroups | 批量获取邮件组
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, mail:mailgroup, mail:mailgroup:readonly
  tokens: tenant_access_token
- GET /open-apis/mail/v1/mailgroups/:mailgroup_id | 查询指定邮件组
  required: mail:mailgroup, mail:mailgroup:readonly
  field: (none)
  all: mail:mailgroup, mail:mailgroup:readonly
  tokens: tenant_access_token
...
- GET /open-apis/mail/v1/public_mailboxes | 查询所有公共邮箱
  ...
  field: contact:user.employee_id:readonly, mail:public_mailbox.public_mailbox_geo
  all: contact:user.employee_id:readonly, mail:public_mailbox, mail:public_mailbox.public_mailbox_geo, mail:public_mailbox:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/mail/v1/public_mailboxes/:public_mailbox_id | 查询指定公共邮箱
  required: mail:public_mailbox, mail:public_mailbox:readonly
  field: mail:public_mailbox.public_mailbox_geo
  all: mail:public_mailbox, mail:public_mailbox.public_mailbox_geo, mail:public_mailbox:readonly
  tokens: tenant_access_token
- GET /open-apis/mail/v1/public_mailboxes/:public_mailbox_id/aliases | 查询公共邮箱的所有别名
  required: mail:public_mailbox, mail:public_mailbox:readonly
  field: (none)
  all: mail:public_mailbox, mail:public_mailbox:readonly
  tokens: tenant_access_token
- GET /open-apis/mail/v1/public_mailboxes/:public_mailbox_id/members | 查询所有公共邮箱成员信息
  required: mail:public_mailbox, mail:public_mailbox:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, mail:public_mailbox, mail:public_mailbox:readonly
  tokens: tenant_access_token
...
- GET /open-apis/mail/v1/user_mailboxes/:user_mailbox_id/aliases | 获取用户邮箱所有别名
  ...
  field: (none)
  all: mail:user_mailbox, mail:user_mailbox:readonly
  tokens: tenant_access_token
...
- GET /open-apis/mail/v1/user_mailboxes/:user_mailbox_id/folders | 列出邮箱文件夹
  ...
  field: (none)
  all: mail:user_mailbox.folder:read, mail:user_mailbox.folder:write
  tokens: tenant_access_token, user_access_token
- GET /open-apis/mail/v1/user_mailboxes/:user_mailbox_id/mail_contacts | 列出邮箱联系人
  ...
  field: mail:user_mailbox.mail_contact.mail_address:read, mail:user_mailbox.mail_contact.phone:read
  all: mail:user_mailbox.mail_contact.mail_address:read, mail:user_mailbox.mail_contact.phone:read, mail:user_mailbox.mail_contact:read, mail:user_mailbox.mail_contact:write
  tokens: tenant_access_token, user_access_token
- GET /open-apis/mail/v1/user_mailboxes/:user_mailbox_id/messages | 列出邮件
  required: mail:user_mailbox.message:readonly
  field: (none)
  all: mail:user_mailbox.message:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/mail/v1/user_mailboxes/:user_mailbox_id/messages/:message_id | 获取邮件详情
  required: mail:user_mailbox.message:readonly
  field: mail:user_mailbox.message.address:read, mail:user_mailbox.message.body:read, mail:user_mailbox.message.subject:read, myai:myai
  all: mail:user_mailbox.message.address:read, mail:user_mailbox.message.body:read, mail:user_mailbox.message.subject:read, mail:user_mailbox.message:readonly, myai:myai
  tokens: tenant_access_token, user_access_token
- GET /open-apis/mail/v1/user_mailboxes/:user_mailbox_id/messages/:message_id/attachments/download_url | 获取附件下载链接
  ...
  field: (none)
  all: mail:user_mailbox.message.body:read
  tokens: tenant_access_token, user_access_token
- GET /open-apis/mail/v1/user_mailboxes/:user_mailbox_id/messages/get_by_card | 获取邮件卡片的邮件列表
  required: mail:user_mailbox.message:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, mail:user_mailbox.message:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/minutes/v1/minutes/:minute_token | 获取妙记信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, minutes:minutes, minutes:minutes.basic:read, minutes:minutes:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/minutes/v1/minutes/:minute_token/artifacts | 获取妙记AI产物
  required: minutes:minutes.artifacts:read
  field: (none)
  all: minutes:minutes.artifacts:read
  tokens: tenant_access_token, user_access_token
- GET /open-apis/minutes/v1/minutes/:minute_token/media | 下载妙记音视频文件
  ...
  field: (none)
  all: minutes:minute:download, minutes:minutes.media:export
  tokens: tenant_access_token, user_access_token
- GET /open-apis/minutes/v1/minutes/:minute_token/statistics | 获取妙记统计数据
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, minutes:minutes, minutes:minutes.statistics:read, minutes:minutes:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/okr/v1/progress_records/:progress_id | 获取 OKR 进展记录
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, okr:okr, okr:okr.progress:readonly, okr:okr:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/okr/v1/reviews/query | 查询复盘信息
  required: okr:okr, okr:okr.review:readonly, okr:okr:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, okr:okr, okr:okr.review:readonly, okr:okr:readonly
  tokens: tenant_access_token
...
- GET /open-apis/performance/v1/semesters | 获取周期列表
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, performance:performance, performance:performance:readonly, performance:semester:read
  tokens: tenant_access_token
- GET /open-apis/performance/v2/metric_tags | 获取指标标签列表
  ...
  field: (none)
  all: performance:metric:read, performance:metric:write, performance:metric_lib:read
  tokens: tenant_access_token
...
- GET /open-apis/report/v1/rules/query | 查询规则
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, report:rule:readonly
  tokens: tenant_access_token
- GET /open-apis/search/v2/data_sources | 批量获取数据源
  required: search:data_source, search:data_source:readonly
  field: (none)
  all: search:data_source, search:data_source:readonly
  tokens: tenant_access_token
...
- GET /open-apis/search/v2/data_sources/:data_source_id/items/:item_id | 查询指定数据项
  ...
  field: (none)
  all: search:data_item:readonly, search:data_source, search:data_source:readonly
  tokens: tenant_access_token
- GET /open-apis/search/v2/schemas/:schema_id | 获取数据范式
  ...
  field: (none)
  all: search:data_schemas:readonly, search:data_source, search:data_source:readonly
  tokens: tenant_access_token
- GET /open-apis/security_and_compliance/v1/multi_geo_entity/tenant | 获取地理位置列表
  ...
  field: (none)
  all: security_and_compliance:multi_geo_entity.tenant:readonly, security_and_compliance:user_migration:multi-geo
  tokens: tenant_access_token, user_access_token
- GET /open-apis/security_and_compliance/v1/user_migrations/:user_id | 获取单个用户迁移状态
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, security_and_compliance:user_migration, security_and_compliance:user_migration:multi-geo, security_and_compliance:user_migration:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/security_and_compliance/v2/device_records | 查询设备信息
  required: security_and_compliance:device_record:read
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, security_and_compliance:device_record:read
  tokens: tenant_access_token
...
- GET /open-apis/security_and_compliance/v2/device_records/mine | 获取客户端设备认证信息
  required: security_and_compliance:device_record:read
  field: (none)
  all: security_and_compliance:device_record:read
  tokens: user_access_token
- GET /open-apis/sheets/v3/spreadsheets/:spreadsheet_token | 获取电子表格信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, drive:drive, drive:drive:readonly, sheets:spreadsheet, sheets:spreadsheet.meta:read, sheets:spreadsheet:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/sheets/v3/spreadsheets/:spreadsheet_token/sheets/:sheet_id | 查询工作表
  ...
  field: (none)
  all: drive:drive, drive:drive:readonly, sheets:spreadsheet, sheets:spreadsheet:read, sheets:spreadsheet:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/spark/v1/apps/:app_id/enums | 获取自定义枚举列表
  ...
  field: (none)
  all: spark:app.table:read, spark:app.table:write
  tokens: user_access_token
...
- GET /open-apis/spark/v1/apps/:app_id/tables/:table_name/records | 查询数据表数据记录
  ...
  field: (none)
  all: spark:app.table.record:read, spark:app.table.record:write
  tokens: user_access_token
...
- GET /open-apis/task/v1/tasks | 查询所有任务
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, task:task:read, task:task:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/task/v1/tasks/:task_id | 查询指定任务
  required: task:task, task:task:read, task:task:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, task:task, task:task:read, task:task:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/task/v1/tasks/:task_id/collaborators | 获取执行者列表
  required: task:personnel:read, task:task, task:task:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, task:personnel:read, task:task, task:task:readonly
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/task/v2/attachments | 列取附件
  ...
  field: (none)
  all: task:attachment:read, task:attachment:write
  tokens: tenant_access_token, user_access_token
- GET /open-apis/task/v2/attachments/:attachment_guid | 获取附件
  ...
  field: (none)
  all: task:attachment:file:download, task:attachment:read, task:attachment:write
  tokens: tenant_access_token, user_access_token
- GET /open-apis/task/v2/comments | 获取评论列表
  required: task:comment:read, task:comment:write
  field: (none)
  all: task:comment:read, task:comment:write
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/task/v2/custom_fields | 列取自定义字段
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, task:custom_field:read, task:custom_field:write
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/task/v2/sections | 获取自定义分组列表
  ...
  field: (none)
  all: task:section:read, task:section:write
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/task/v2/tasklists | 获取清单列表
  ...
  field: (none)
  all: task:tasklist:read, task:tasklist:write
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/task/v2/tasklists/:tasklist_guid/activity_subscriptions | 列取动态订阅
  required: task:tasklist:read, task:tasklist:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, task:tasklist:read, task:tasklist:write
  tokens: tenant_access_token, user_access_token
...
- GET /open-apis/task/v2/tasks | 列取任务列表
  ...
  field: (none)
  all: task:task:read, task:task:write
  tokens: user_access_token
...
- GET /open-apis/vc/v1/meeting_list | 查询会议明细
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:room:readonly, vc:rooms.room.detailinfo:read
  tokens: tenant_access_token, user_access_token
- GET /open-apis/vc/v1/meetings/:meeting_id | 获取会议详情
  required: vc:meeting.meetingevent:read, vc:meeting:readonly
  field: contact:user.employee_id:readonly, vc:meeting.artifact.note:read, vc:meeting.artifact.verbatim:read
  all: contact:user.employee_id:readonly, vc:meeting.artifact.note:read, vc:meeting.artifact.verbatim:read, vc:meeting.meetingevent:read, vc:meeting:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/vc/v1/meetings/:meeting_id/recording | 获取录制文件
  required: vc:record:readonly
  field: (none)
  all: vc:record:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/vc/v1/meetings/list_by_no | 获取与会议号关联的会议列表
  required: vc:meeting.meetingid:read, vc:meeting:readonly
  field: (none)
  all: vc:meeting.meetingid:read, vc:meeting:readonly
  tokens: tenant_access_token, user_access_token
- GET /open-apis/vc/v1/notes/:note_id | 获取纪要详情
  required: vc:note:read
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:note:read
  tokens: user_access_token
...
- GET /open-apis/vc/v1/reports/get_daily | 获取会议报告
  ...
  field: (none)
  all: vc:report:readonly
  tokens: tenant_access_token
- GET /open-apis/vc/v1/reports/get_top_user | 获取 Top 用户列表
  required: vc:report:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:report:readonly
  tokens: tenant_access_token
- GET /open-apis/vc/v1/reserve_configs/:reserve_config_id/admin | 查询会议室预定管理员
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:room, vc:room:readonly, vc:rooms.room.basicinfo:read
  tokens: tenant_access_token
...
- GET /open-apis/vc/v1/reserves/:reserve_id | 获取预约
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:reserve:readonly
  tokens: tenant_access_token, user_access_token
...
- PATCH /open-apis/application/v6/applications/:app_id | 更新应用分组信息
  ...
  field: (none)
  all: admin:app.category:update, application:application
  tokens: tenant_access_token
- PATCH /open-apis/application/v6/applications/:app_id/app_versions/:version_id | 更新应用审核状态
  ...
  field: contact:user.employee_id:readonly
  all: application:application.app_version, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- PATCH /open-apis/application/v7/applications/:app_id/config | 更新应用开发配置
  required: application:application:patch
  field: contact:user.employee_id:readonly
  all: application:application:patch, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
...
- PATCH /open-apis/calendar/v4/calendars/:calendar_id | 更新日历信息
  ...
  field: (none)
  all: calendar:calendar, calendar:calendar:update
  tokens: tenant_access_token, user_access_token
- PATCH /open-apis/calendar/v4/calendars/:calendar_id/events/:event_id | 更新日程
  required: calendar:calendar, calendar:calendar.event:update
  field: contact:user.employee_id:readonly
  all: calendar:calendar, calendar:calendar.event:update, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
...
- PATCH /open-apis/contact/v3/departments/:department_id | 修改部门部分信息
  required: contact:contact
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:department.base:readonly, contact:department.hrbp:readonly, contact:department.organize:readonly, contact:user.employee_id:readonly
  all: contact:contact, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:department.base:readonly, contact:department.hrbp:readonly, contact:department.organize:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token
- PATCH /open-apis/contact/v3/departments/:department_id/update_department_id | 更新部门 ID
  ...
  field: (none)
  all: contact:contact:update_department_id
  tokens: tenant_access_token
- PATCH /open-apis/contact/v3/functional_roles/:role_id/members/batch_delete | 删除角色下的成员
  required: contact:functional_role
  field: contact:user.employee_id:readonly
  all: contact:functional_role, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- PATCH /open-apis/contact/v3/group/:group_id | 更新用户组
  required: contact:group
  field: contact:user.employee_id:readonly
  all: contact:group, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- PATCH /open-apis/contact/v3/users/:user_id | 修改用户部分信息
  ...
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly, contact:user.department:readonly, contact:user.dotted_line_leader_info.read, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.employee_number:read, contact:user.gender:readonly, contact:user.job_family:readonly, contact:user.job_level:readonly, contact:user.phone:readonly, contact:user.union_id:readonly, directory:employee.base.email:read
  all: contact:contact, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base, contact:user.base:readonly, contact:user.department:readonly, contact:user.dotted_line_leader_info.read, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.employee_number:read, contact:user.gender:readonly, contact:user.job_family:readonly, contact:user.job_level:readonly, contact:user.phone:readonly, contact:user.union_id:readonly, directory:employee.base.email:read
  tokens: tenant_access_token, user_access_token
- PATCH /open-apis/contact/v3/users/:user_id/update_user_id | 更新用户 ID
  required: contact:contact:update_user_id
  field: contact:user.employee_id:readonly
  all: contact:contact:update_user_id, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- PATCH /open-apis/corehr/v1/departments/:department_id | 更新部门
  required: corehr:corehr, corehr:department:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:corehr, corehr:department:write
  tokens: tenant_access_token
...
- PATCH /open-apis/corehr/v1/employments/:employment_id | 更新雇佣信息
  ...
  field: contact:user.employee_id:readonly, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read, corehr:job_data.work_shift:read
  all: contact:user.employee_id:readonly, corehr:corehr, corehr:employment.patch:write, corehr:employment:write, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read, corehr:job_data.work_shift:read
  tokens: tenant_access_token
- PATCH /open-apis/corehr/v1/job_datas/:job_data_id | 更新任职信息
  required: corehr:corehr, corehr:job_data:write
  field: contact:user.employee_id:readonly, corehr:employment.pathway:read, corehr:employment.pathway:write, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read, corehr:job_data.work_shift:read
  all: contact:user.employee_id:readonly, corehr:corehr, corehr:employment.pathway:read, corehr:employment.pathway:write, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read, corehr:job_data.work_shift:read, corehr:job_data:write
  tokens: tenant_access_token
...
- PATCH /open-apis/corehr/v2/cost_centers/:cost_center_id | 启用 / 停用成本中心
  required: corehr:cost_center:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:cost_center:write
  tokens: tenant_access_token
...
- PATCH /open-apis/corehr/v2/custom_orgs/:org_id | 更新自定义组织信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:custom_org:write
  tokens: tenant_access_token
...
- PATCH /open-apis/corehr/v2/employees/additional_jobs/:additional_job_id | 更新兼职
  required: corehr:additional_job:write
  field: contact:user.employee_id:readonly, corehr:additional_job.compensation_type:write, corehr:additional_job.job:write, corehr:additional_job.job_level:write, corehr:additional_job.position:write, corehr:additional_job.service_company:write, corehr:additional_job.work_shift:write
  all: contact:user.employee_id:readonly, corehr:additional_job.compensation_type:write, corehr:additional_job.job:write, corehr:additional_job.job_level:write, corehr:additional_job.position:write, corehr:additional_job.service_company:write, corehr:additional_job.work_shift:write, corehr:additional_job:write
  tokens: tenant_access_token
- PATCH /open-apis/corehr/v2/employees/international_assignments/:international_assignment_id | 更新外派信息
  required: corehr:employees.international_assignment:write
  field: contact:user.employee_id:readonly, corehr:employment.international_assignment.accommodation:write, corehr:employment.international_assignment.compensation_type:write, corehr:employment.international_assignment.custom_field:write, corehr:employment.international_assignment.international_assignment_allowance:write, corehr:employment.international_assignment.job:write, corehr:employment.international_assignment.job_grade:write, corehr:employment.international_assignment.job_level:write, corehr:employment.international_assignment.position:write, corehr:employment.international_assignment.service_company:write, corehr:employment.international_assignment.weekly_working_hours:write, corehr:employment.international_assignment.work_calendar:write, corehr:employment.international_assignment.work_location:write, corehr:employment.international_assignment.work_shift:write, corehr:employment.international_assignment.working_hours_type:write
  all: contact:user.employee_id:readonly, corehr:employees.international_assignment:write, corehr:employment.international_assignment.accommodation:write, corehr:employment.international_assignment.compensation_type:write, corehr:employment.international_assignment.custom_field:write, corehr:employment.international_assignment.international_assignment_allowance:write, corehr:employment.international_assignment.job:write, corehr:employment.international_assignment.job_grade:write, corehr:employment.international_assignment.job_level:write, corehr:employment.international_assignment.position:write, corehr:employment.international_assignment.service_company:write, corehr:employment.international_assignment.weekly_working_hours:write, corehr:employment.international_assignment.work_calendar:write, corehr:employment.international_assignment.work_location:write, corehr:employment.international_assignment.work_shift:write, corehr:employment.international_assignment.working_hours_type:write
  tokens: tenant_access_token
...
- PATCH /open-apis/corehr/v2/persons/:person_id | 更新个人信息
  ...
  field: corehr:person.address:read, corehr:person.address:write, corehr:person.bank_account:read, corehr:person.bank_account:write, corehr:person.born_country_region:read, corehr:person.born_country_region:write, corehr:person.custom_field:read, corehr:person.custom_field:write, corehr:person.date_entered_workforce:read, corehr:person.date_entered_workforce:write, corehr:person.date_of_birth:read, corehr:person.date_of_birth:write, corehr:person.dependent:read, corehr:person.dependent:write, corehr:person.education:read, corehr:person.education:write, corehr:person.email:read, corehr:person.email:write, corehr:person.emergency_contact:read, corehr:person.emergency_contact:write, corehr:person.entry_leave_time:read, corehr:person.entry_leave_time:write, corehr:person.gender:read, corehr:person.gender:write, corehr:person.hukou:read, corehr:person.hukou:write, corehr:person.is_disabled:read, corehr:person.is_disabled:write, corehr:person.is_old_alone:read, corehr:person.is_old_alone:write, corehr:person.legal_name:read, corehr:person.legal_name:write, corehr:person.marital_status:read, corehr:person.marital_status:write, corehr:person.martyr_family:read, corehr:person.martyr_family:write, corehr:person.national_id:read, corehr:person.national_id:write, corehr:person.nationality:read, corehr:person.nationality:write, corehr:person.native_region:read, corehr:person.native_region:write, corehr:person.personal_profile:read, corehr:person.personal_profile:write, corehr:person.phone:read, corehr:person.phone:write, corehr:person.race:read, corehr:person.resident_tax:read, corehr:person.resident_tax:write, corehr:person.resident_tax_custom_field:read, corehr:person.resident_tax_custom_field:write, corehr:person.work_experience:read, corehr:person.work_experience:write
  all: corehr:person.address:read, corehr:person.address:write, corehr:person.bank_account:read, corehr:person.bank_account:write, corehr:person.born_country_region:read, corehr:person.born_country_region:write, corehr:person.custom_field:read, corehr:person.custom_field:write, corehr:person.date_entered_workforce:read, corehr:person.date_entered_workforce:write, corehr:person.date_of_birth:read, corehr:person.date_of_birth:write, corehr:person.dependent:read, corehr:person.dependent:write, corehr:person.education:read, corehr:person.education:write, corehr:person.email:read, corehr:person.email:write, corehr:person.emergency_contact:read, corehr:person.emergency_contact:write, corehr:person.entry_leave_time:read, corehr:person.entry_leave_time:write, corehr:person.gender:read, corehr:person.gender:write, corehr:person.hukou:read, corehr:person.hukou:write, corehr:person.is_disabled:read, corehr:person.is_disabled:write, corehr:person.is_old_alone:read, corehr:person.is_old_alone:write, corehr:person.legal_name:read, corehr:person.legal_name:write, corehr:person.marital_status:read, corehr:person.marital_status:write, corehr:person.martyr_family:read, corehr:person.martyr_family:write, corehr:person.national_id:read, corehr:person.national_id:write, corehr:person.nationality:read, corehr:person.nationality:write, corehr:person.native_region:read, corehr:person.native_region:write, corehr:person.personal_profile:read, corehr:person.personal_profile:write, corehr:person.phone:read, corehr:person.phone:write, corehr:person.race:read, corehr:person.resident_tax:read, corehr:person.resident_tax:write, corehr:person.resident_tax_custom_field:read, corehr:person.resident_tax_custom_field:write, corehr:person.work_experience:read, corehr:person.work_experience:write, corehr:person:write
  tokens: tenant_access_token
- PATCH /open-apis/corehr/v2/positions/:position_id | 更新岗位信息
  required: corehr:position:write
  field: (none)
  all: corehr:position:write
  tokens: tenant_access_token
- PATCH /open-apis/corehr/v2/pre_hires/:pre_hire_id | 更新待入职信息
  required: corehr:pre_hire:update
  field: (none)
  all: corehr:pre_hire:update
  tokens: tenant_access_token
...
- PATCH /open-apis/directory/v1/departments/:department_id | 更新部门
  ...
  field: (none)
  all: directory:department.update:write, directory:department:write
  tokens: tenant_access_token, user_access_token
...
- PATCH /open-apis/docx/v1/chats/:chat_id/announcement/blocks/batch_update | 批量更新群公告块的内容
  required: im:chat.announcement:write_only
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, im:chat.announcement:write_only
  tokens: tenant_access_token, user_access_token
- PATCH /open-apis/docx/v1/documents/:document_id/blocks/:block_id | 更新块的内容
  required: docx:document, docx:document:write_only
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, docx:document, docx:document:write_only
  tokens: tenant_access_token, user_access_token
...
- PATCH /open-apis/drive/v1/files/:file_token/subscriptions/:subscription_id | 更新订阅状态
  ...
  field: (none)
  all: docs:document.subscription, drive:drive, drive:drive:readonly
  tokens: user_access_token
- PATCH /open-apis/drive/v2/permissions/:token/public | 更新云文档权限设置
  ...
  field: (none)
  all: bitable:bitable, docs:doc, docs:permission.setting:write_only, docx:document, drive:drive, drive:file, sheets:spreadsheet, wiki:wiki
  tokens: tenant_access_token, user_access_token
...
- PATCH /open-apis/helpdesk/v1/notifications/:notification_id | 更新推送
  required: helpdesk:all
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, helpdesk:all
  tokens: user_access_token
...
- PATCH /open-apis/hire/v1/employees/:employee_id | 更新员工状态
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:employee
  tokens: tenant_access_token
...
- PATCH /open-apis/hire/v1/interviewers/:interviewer_id | 更新面试官信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:interviewer
  tokens: tenant_access_token
- PATCH /open-apis/hire/v1/notes/:note_id | 更新备注
  required: hire:note
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:note
  tokens: tenant_access_token
...
- PATCH /open-apis/im/v1/chats/:chat_id/announcement | 更新群公告信息
  ...
  field: (none)
  all: im:chat, im:chat.announcement:write_only
  tokens: tenant_access_token, user_access_token
- PATCH /open-apis/im/v1/chats/:chat_id/members/me_join | 用户或机器人主动加入群聊
  required: im:chat, im:chat.members:write_only
  field: (none)
  all: im:chat, im:chat.members:write_only
  tokens: tenant_access_token, user_access_token
...
- PATCH /open-apis/im/v1/messages/:message_id | 更新已发送的消息卡片
  ...
  field: (none)
  all: im:message, im:message:send_as_bot, im:message:update
  tokens: tenant_access_token, user_access_token
- PATCH /open-apis/im/v2/feed_cards/:feed_card_id | 即时提醒
  required: im:datasync.feed_card.time_sensitive:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, im:datasync.feed_card.time_sensitive:write
  tokens: tenant_access_token
...
- PATCH /open-apis/okr/v1/periods/:period_id | 修改 OKR 周期状态
  ...
  field: (none)
  all: okr:okr, okr:okr.period:writeonly
  tokens: tenant_access_token
...
- PATCH /open-apis/search/v2/data_sources/:data_source_id | 修改数据源
  ...
  field: (none)
  all: search:data_source, search:data_source:update
  tokens: tenant_access_token
- PATCH /open-apis/search/v2/schemas/:schema_id | 修改数据范式
  ...
  field: (none)
  all: search:data_schemas:update, search:data_source, search:data_source:readonly
  tokens: tenant_access_token
- PATCH /open-apis/sheets/v3/spreadsheets/:spreadsheet_token | 修改电子表格属性
  ...
  field: (none)
  all: drive:drive, sheets:spreadsheet, sheets:spreadsheet.meta:write_only
  tokens: tenant_access_token, user_access_token
...
- PATCH /open-apis/task/v1/tasks/:task_id | 更新任务
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, task:task, task:task:writeonly
  tokens: tenant_access_token, user_access_token
- PATCH /open-apis/task/v2/comments/:comment_id | 更新评论
  required: task:comment:write, task:comment:writeonly
  field: (none)
  all: task:comment:write, task:comment:writeonly
  tokens: tenant_access_token, user_access_token
- PATCH /open-apis/task/v2/custom_fields/:custom_field_guid | 更新自定义字段
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, task:custom_field:write, task:custom_field:writeonly
  tokens: tenant_access_token, user_access_token
...
- PATCH /open-apis/vc/v1/meetings/:meeting_id/invite | 邀请参会人
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:meeting, vc:meeting.participant:write
  tokens: user_access_token
- PATCH /open-apis/vc/v1/meetings/:meeting_id/recording/set_permission | 授权录制文件
  required: vc:record
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:record
  tokens: user_access_token
...
- PATCH /open-apis/vc/v1/reserve_configs/:reserve_config_id | 更新会议室预定限制
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:room, vc:rooms.room:update
  tokens: tenant_access_token
...
- PATCH /open-apis/vc/v1/room_levels/:room_level_id | 更新会议室层级
  ...
  field: (none)
  all: vc:room, vc:rooms.roomlevel:update
  tokens: tenant_access_token
...
- POST /open-apis/acs/v1/rule_external | 创建或更新权限组
  required: acs:device:write, acs:users
  field: contact:user.employee_id:readonly
  all: acs:device:write, acs:users, contact:user.employee_id:readonly
  tokens: user_access_token
...
- POST /open-apis/admin/v1/password/reset | 重置用户的企业邮箱密码
  ...
  field: contact:user.employee_id:readonly
  all: admin:ent_email_password, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- POST /open-apis/apaas/v1/applications/:namespace/functions/:function_api_name/invoke | 执行函数
  ...
  field: (none)
  all: app_engine:application.function:write
  tokens: tenant_access_token
...
- POST /open-apis/apaas/v1/applications/:namespace/objects/:object_api_name/records/:id/query | 获取记录详情
  ...
  field: (none)
  all: app_engine:object.record:read
  tokens: tenant_access_token
...
- POST /open-apis/apaas/v1/applications/:namespace/objects/oql_query | 执行 OQL
  ...
  field: (none)
  all: app_engine:object.record:read, app_engine:object.record:write
  tokens: tenant_access_token
...
- POST /open-apis/apaas/v1/applications/:namespace/record_permissions/:record_permission_api_name/member/batch_create_authorization | 批量创建记录权限用户授权
  ...
  field: (none)
  all: app_engine:record_permission.member:write
  tokens: tenant_access_token
...
- POST /open-apis/apaas/v1/applications/:namespace/roles/:role_api_name/member/batch_create_authorization | 批量创建角色成员授权
  ...
  field: (none)
  all: app_engine:role.member:write
  tokens: tenant_access_token
...
- POST /open-apis/apaas/v1/workspaces/:workspace_id/sql_commands | 执行SQL
  ...
  field: (none)
  all: app_engine:workspace.sql_commands:write
  tokens: user_access_token
...
- POST /open-apis/application/v6/app_badge/set | 更新应用红点
  required: (none)
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly
  tokens: tenant_access_token
- POST /open-apis/application/v6/applications/:app_id/app_usage/department_overview | 获取多部门应用使用概览
  ...
  field: (none)
  all: application:application.app_usage_stats.overview:readonly
  tokens: tenant_access_token
- POST /open-apis/application/v6/applications/:app_id/app_usage/message_push_overview | 获取消息推送概览
  ...
  field: (none)
  all: application:application.app_message_stats.overview:readonly
  tokens: tenant_access_token
...
- POST /open-apis/approval/v4/approvals | 创建审批定义
  ...
  field: contact:user.employee_id:readonly
  all: approval:approval, approval:definition, contact:user.employee_id:readonly
  tokens: tenant_access_token
- POST /open-apis/approval/v4/approvals/:approval_code/subscribe | 订阅审批事件
  required: approval:approval, approval:definition
  field: (none)
  all: approval:approval, approval:definition
  tokens: tenant_access_token
...
- POST /open-apis/approval/v4/external_instances | 同步三方审批实例
  ...
  field: (none)
  all: approval:approval, approval:external_instance
  tokens: tenant_access_token
- POST /open-apis/approval/v4/external_instances/check | 校验三方审批实例
  ...
  field: (none)
  all: approval:approval, approval:approval:readonly, approval:external_instance
  tokens: tenant_access_token
- POST /open-apis/approval/v4/instances | 创建审批实例
  required: approval:approval, approval:instance
  field: (none)
  all: approval:approval, approval:instance
  tokens: tenant_access_token
...
- POST /open-apis/approval/v4/instances/add_sign | 审批任务加签
  ...
  field: (none)
  all: approval:approval, approval:approval:readonly, approval:task
  tokens: tenant_access_token
...
- POST /open-apis/approval/v4/instances/query | 查询实例列表
  ...
  field: contact:user.employee_id:readonly
  all: approval:approval.list:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- POST /open-apis/approval/v4/instances/specified_rollback | 退回审批任务
  required: approval:approval, approval:approval:readonly, approval:task
  field: contact:user.employee_id:readonly
  all: approval:approval, approval:approval:readonly, approval:task, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- POST /open-apis/approval/v4/tasks/search | 查询任务列表
  ...
  field: contact:user.employee_id:readonly
  all: approval:approval.list:readonly, approval:approval:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- POST /open-apis/baike/v1/drafts | 创建草稿
  ...
  field: contact:user.employee_id:readonly
  all: baike:entity, baike:entity:exempt_review, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
- POST /open-apis/baike/v1/entities | 创建免审词条
  required: baike:entity:exempt_review
  field: contact:user.employee_id:readonly
  all: baike:entity:exempt_review, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/batch_get | 批量获取记录
  ...
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly
  all: base:record:read, bitable:app, bitable:app:readonly, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly
  tokens: tenant_access_token, user_access_token
- POST /open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/batch_update | 更新多条记录
  ...
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly, contact:user.employee_id:readonly
  all: base:record:update, bitable:app, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
- POST /open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/search | 查询记录
  ...
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly, contact:user.employee_id:readonly
  all: base:record:retrieve, bitable:app, bitable:app:readonly, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/board/v1/whiteboards/:whiteboard_id/nodes/plantuml | 解析画板语法
  ...
  field: (none)
  all: board:whiteboard:node:create
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/calendar/v4/calendars | 创建共享日历
  ...
  field: (none)
  all: calendar:calendar, calendar:calendar:create
  tokens: tenant_access_token, user_access_token
- POST /open-apis/calendar/v4/calendars/:calendar_id/acls | 创建访问控制
  required: calendar:calendar, calendar:calendar.acl:create
  field: contact:user.employee_id:readonly
  all: calendar:calendar, calendar:calendar.acl:create, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
- POST /open-apis/calendar/v4/calendars/:calendar_id/acls/subscription | 订阅日历访问控制变更事件
  required: calendar:calendar, calendar:calendar.acl:read, calendar:calendar:readonly
  field: (none)
  all: calendar:calendar, calendar:calendar.acl:read, calendar:calendar:readonly
  tokens: user_access_token
...
- POST /open-apis/calendar/v4/calendars/:calendar_id/events | 创建日程
  ...
  field: contact:user.employee_id:readonly
  all: calendar:calendar, calendar:calendar.event:create, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/calendar/v4/calendars/:calendar_id/events/:event_id/attendees/batch_delete | 删除日程参与人
  ...
  field: contact:user.employee_id:readonly
  all: calendar:calendar, calendar:calendar.event:update, calendar:calendar.event:writeonly, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/calendar/v4/calendars/:calendar_id/events/:event_id/reply | 回复日程
  ...
  field: (none)
  all: calendar:calendar, calendar:calendar.event:reply, calendar:calendar.event:writeonly
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/calendar/v4/calendars/:calendar_id/subscribe | 订阅日历
  ...
  field: (none)
  all: calendar:calendar, calendar:calendar:subscribe
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/calendar/v4/calendars/mget | 批量查询日历信息
  ...
  field: contact:user.employee_id:readonly
  all: calendar:calendar.calendar:readonly, calendar:calendar:read, calendar:calendar:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/calendar/v4/exchange_bindings | 将 Exchange 账户绑定到飞书账户
  ...
  field: contact:user.email:readonly, contact:user.employee_id:readonly, directory:employee.base.email:read
  all: calendar:calendar, calendar:calendar:readonly, calendar:exchange.bindings:create, contact:user.email:readonly, contact:user.employee_id:readonly, directory:employee.base.email:read
  tokens: user_access_token
- POST /open-apis/calendar/v4/freebusy/batch | 批量查询主日历日程忙闲信息
  ...
  field: contact:user.employee_id:readonly
  all: calendar:calendar, calendar:calendar.free_busy:read, calendar:calendar:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/calendar/v4/settings/generate_caldav_conf | 生成 CalDAV 配置
  ...
  field: (none)
  all: calendar:calendar, calendar:setting:generate_caldav_conf, calendar:settings.caldav:create
  tokens: user_access_token
- POST /open-apis/calendar/v4/timeoff_events | 创建请假日程
  required: calendar:time_off:create, calendar:timeoff
  field: contact:user.employee_id:readonly
  all: calendar:time_off:create, calendar:timeoff, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- POST /open-apis/compensation/v1/archives | 创建薪资档案
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:compensation_archive:write
  tokens: tenant_access_token, user_access_token
- POST /open-apis/compensation/v1/archives/query | 批量查询员工薪资档案
  required: corehr:compensation_archive_detail:read
  field: contact:user.employee_id:readonly, corehr:compensation_archive_detail.change_description:read, corehr:compensation_archive_detail.indicators:read, corehr:compensation_archive_detail.items:read, corehr:compensation_archive_detail.plan:read, corehr:compensation_archive_detail.salary_level:read
  all: contact:user.employee_id:readonly, corehr:compensation_archive_detail.change_description:read, corehr:compensation_archive_detail.indicators:read, corehr:compensation_archive_detail.items:read, corehr:compensation_archive_detail.plan:read, corehr:compensation_archive_detail.salary_level:read, corehr:compensation_archive_detail:read
  tokens: tenant_access_token, user_access_token
- POST /open-apis/compensation/v1/lump_sum_payment/batch_create | 批量创建一次性支付记录
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:compensation.lump_sum_payment:write
  tokens: tenant_access_token
- POST /open-apis/compensation/v1/lump_sum_payment/batch_remove | 批量删除一次性支付记录
  required: corehr:compensation.lump_sum_payment:write
  field: (none)
  all: corehr:compensation.lump_sum_payment:write
  tokens: tenant_access_token
...
- POST /open-apis/compensation/v1/lump_sum_payment/query | 查询一次性支付授予记录
  ...
  field: contact:user.employee_id:readonly, corehr:compensation_lump_sum_payment.binding_period_offboarding_type:read, corehr:compensation_lump_sum_payment.return_amount_after_tax:read, corehr:compensation_lump_sum_payment.return_amount_before_tax:read, corehr:compensation_lump_sum_payment_detail.belong_time:read
  all: contact:user.employee_id:readonly, corehr:compensation.lump_sum_payment:read, corehr:compensation_lump_sum_payment.binding_period_offboarding_type:read, corehr:compensation_lump_sum_payment.return_amount_after_tax:read, corehr:compensation_lump_sum_payment.return_amount_before_tax:read, corehr:compensation_lump_sum_payment_detail.belong_time:read
  tokens: tenant_access_token
- POST /open-apis/compensation/v1/lump_sum_payment/query_detail | 查询一次性支付授予明细
  required: corehr:compensation.lump_sum_payment:read
  field: contact:user.employee_id:readonly, corehr:compensation_lump_sum_payment_detail.belong_time:read
  all: contact:user.employee_id:readonly, corehr:compensation.lump_sum_payment:read, corehr:compensation_lump_sum_payment_detail.belong_time:read
  tokens: tenant_access_token
- POST /open-apis/compensation/v1/recurring_payment/batch_create | 批量创建经常性支付记录
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:compensation.recurring_payment:write
  tokens: tenant_access_token
- POST /open-apis/compensation/v1/recurring_payment/batch_remove | 批量删除经常性支付记录
  ...
  field: (none)
  all: corehr:compensation.recurring_payment:delete
  tokens: tenant_access_token
- POST /open-apis/compensation/v1/recurring_payment/batch_update | 批量更正经常性支付记录
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:compensation.recurring_payment:update
  tokens: tenant_access_token
- POST /open-apis/compensation/v1/recurring_payment/query | 查询经常性支付记录
  required: corehr:compensation.recurring_payment:read
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:compensation.recurring_payment:read
  tokens: tenant_access_token
- POST /open-apis/compensation/v1/social_archive_adjust_record/query | 通过员工ID批量获取社保增减员记录
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:compensation.social_adjust_record:read
  tokens: tenant_access_token
- POST /open-apis/compensation/v1/social_archive/query | 批量获取员工参保档案
  required: corehr:compensation.social_archive:read
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:compensation.social_archive:read
  tokens: tenant_access_token
...
- POST /open-apis/contact/v3/departments/search | 搜索部门
  ...
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:department.base:readonly, contact:department.hrbp:readonly, contact:department.organize:readonly, contact:user.employee_id:readonly
  all: contact:contact.base:readonly, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:department.base:readonly, contact:department.hrbp:readonly, contact:department.organize:readonly, contact:user.employee_id:readonly, search:department:read
  tokens: user_access_token
...
- POST /open-apis/contact/v3/users | 创建用户
  required: contact:contact
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly, contact:user.department:readonly, contact:user.dotted_line_leader_info.read, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.employee_number:read, contact:user.gender:readonly, contact:user.job_family:readonly, contact:user.job_level:readonly, contact:user.phone:readonly, contact:user.union_id:readonly, contact:user.user_geo, directory:employee.base.email:read
  all: contact:contact, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.base:readonly, contact:user.department:readonly, contact:user.dotted_line_leader_info.read, contact:user.email:readonly, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.employee_number:read, contact:user.gender:readonly, contact:user.job_family:readonly, contact:user.job_level:readonly, contact:user.phone:readonly, contact:user.union_id:readonly, contact:user.user_geo, directory:employee.base.email:read
  tokens: tenant_access_token
...
- POST /open-apis/contact/v3/users/basic_batch | 通过 ID 获取用户姓名
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.basic_profile:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
- POST /open-apis/contact/v3/users/batch_get_id | 通过手机号或邮箱获取用户 ID
  required: contact:user.id:readonly
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.employee:readonly, contact:user.employee_id:readonly
  all: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:user.employee:readonly, contact:user.employee_id:readonly, contact:user.id:readonly
  tokens: tenant_access_token
- POST /open-apis/corehr/departments/query_operation_logs | 批量查询部门操作日志
  required: corehr:department.operation_log:read
  field: (none)
  all: corehr:department.operation_log:read
  tokens: tenant_access_token
- POST /open-apis/corehr/v1/assigned_users/search | 获取组织类角色授权列表
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:authorization:read, corehr:corehr, corehr:corehr:readonly
  tokens: tenant_access_token
- POST /open-apis/corehr/v1/authorizations/add_role_assign | 为用户授权角色
  required: corehr:authorization:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:authorization:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v1/employments | 创建雇佣信息
  required: corehr:corehr, corehr:employment:write
  field: (none)
  all: corehr:corehr, corehr:employment:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v1/job_changes | 发起员工异动(不推荐)
  required: corehr:corehr, corehr:job_change:write
  field: contact:user.employee_id:readonly, corehr:job_change.employment_custom_field:read, corehr:job_change.pathway:read, corehr:job_change.pathway:write, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read
  all: contact:user.employee_id:readonly, corehr:corehr, corehr:job_change.employment_custom_field:read, corehr:job_change.pathway:read, corehr:job_change.pathway:write, corehr:job_change:write, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v1/leave_granting_records | 创建假期发放记录
  required: corehr:corehr, corehr:leave_granting_record:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:corehr, corehr:leave_granting_record:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v1/leaves/work_calendar | 获取工作日历
  ...
  field: (none)
  all: corehr:common_data.basic_data:read, corehr:corehr:readonly, corehr:employee:read, corehr:work_calendar:read
  tokens: tenant_access_token
- POST /open-apis/corehr/v1/leaves/work_calendar_date | 获取工作日历日期详情
  ...
  field: (none)
  all: corehr:corehr, corehr:corehr:readonly, corehr:work_calendar:read
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/corehr/v1/offboardings/search | 搜索离职信息
  ...
  field: contact:user.employee_id:readonly, corehr:employment.offboarding_reason:read, corehr:offboarding.block_list:read, corehr:offboarding.block_list:write, corehr:offboarding.custom_field:read, corehr:offboarding.last_attendance_date:read, corehr:offboarding.noncompete_agreement:read, corehr:offboarding.retain_account:read, corehr:offboarding.retain_account:write, corehr:offboarding.signature:read, corehr:offboarding.social_insurance:read
  all: contact:user.employee_id:readonly, corehr:employment.offboarding_reason:read, corehr:offboarding.block_list:read, corehr:offboarding.block_list:write, corehr:offboarding.custom_field:read, corehr:offboarding.last_attendance_date:read, corehr:offboarding.noncompete_agreement:read, corehr:offboarding.retain_account:read, corehr:offboarding.retain_account:write, corehr:offboarding.signature:read, corehr:offboarding.social_insurance:read, corehr:offboarding:read, corehr:offboarding:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v1/offboardings/submit | 操作员工离职
  required: corehr:corehr, corehr:offboarding:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:corehr, corehr:offboarding:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v1/persons/upload | 上传文件
  ...
  field: (none)
  all: corehr:corehr, corehr:file:write, corehr:person:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v1/security_groups/query | 查询部门 / 地点的 HRBP / 属地 BP
  ...
  field: (none)
  all: corehr:authorization.bp:read, corehr:authorization:read, corehr:corehr, corehr:corehr:readonly
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/approval_groups/open_query_department_change_list_by_ids | 批量查询部门调整内容
  ...
  field: contact:user.employee_id:readonly, corehr:orgrole_info:read
  all: contact:user.employee_id:readonly, corehr:approval_groups.orgdraft_department_change:read, corehr:orgrole_info:read
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/approval_groups/open_query_job_change_list_by_ids | 批量查询人员调整内容
  ...
  field: contact:user.employee_id:readonly, corehr:employment.job:read, corehr:employment.job_grade:read, corehr:employment.job_grade:write, corehr:employment.job_level:read, corehr:employment.job_level:write
  all: contact:user.employee_id:readonly, corehr:approval_groups.orgdraft_job_change:read, corehr:employment.job:read, corehr:employment.job_grade:read, corehr:employment.job_grade:write, corehr:employment.job_level:read, corehr:employment.job_level:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/approval_groups/open_query_position_change_list_by_ids | 批量查询岗位调整内容
  ...
  field: contact:user.employee_id:readonly, corehr:position.direct_leader:read, corehr:position.employee_type:read, corehr:position.job:read, corehr:position.job_family:read, corehr:position.job_grade:read, corehr:position.job_level:read, corehr:position.working_hours_type:read
  all: contact:user.employee_id:readonly, corehr:approval_groups.orgdraft_position_change:read, corehr:position.direct_leader:read, corehr:position.employee_type:read, corehr:position.job:read, corehr:position.job_family:read, corehr:position.job_grade:read, corehr:position.job_level:read, corehr:position.working_hours_type:read
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/basic_info/bank_branchs/search | 查询支行信息
  required: corehr:common_data.basic_data:read
  field: (none)
  all: corehr:common_data.basic_data:read
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/bps/get_by_department | 查询部门 HRBP
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:bp.get_by_department:read
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/companies/active | 启用/停用公司
  required: corehr:company:write
  field: (none)
  all: corehr:company:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/contracts/search | 搜索合同
  ...
  field: contact:user.employee_id:readonly, corehr:contract.company:read, corehr:contract.company:write, corehr:contract.period:read, corehr:contract.period:write
  all: contact:user.employee_id:readonly, corehr:contract.company:read, corehr:contract.company:write, corehr:contract.period:read, corehr:contract.period:write, corehr:contract:read, corehr:contract:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/cost_allocations/batch_query | 查询成本分摊
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:cost_allocation:read, corehr:cost_allocation:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/cost_allocations/create_version | 创建成本分摊
  required: corehr:cost_allocation:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:cost_allocation:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/cost_centers/search | 搜索成本中心信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:cost_center:read
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/custom_org/create_emp_custom_org | 新增人员自定义组织变更记录
  required: corehr:employment.custom_org:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:employment.custom_org:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/custom_orgs/query | 查询自定义组织信息
  required: corehr:custom_org:read, corehr:custom_org:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:custom_org:read, corehr:custom_org:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/default_cost_centers/batch_query | 查询默认成本中心
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:default_cost_center:read, corehr:default_cost_center:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/default_cost_centers/create_version | 添加默认成本中心
  required: corehr:default_cost_center:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:default_cost_center:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/departments/parents | 获取父部门信息
  ...
  field: (none)
  all: corehr:department.organize:read
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/departments/query_multi_timeline | 批量查询部门版本信息
  required: corehr:department:read, corehr:department:write
  field: contact:user.employee_id:readonly, corehr:department.custom_fields:read, corehr:department.manager:read, corehr:department.organize:read
  all: contact:user.employee_id:readonly, corehr:department.custom_fields:read, corehr:department.manager:read, corehr:department.organize:read, corehr:department:read, corehr:department:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/departments/search | 搜索部门信息
  required: corehr:department:read, corehr:department:write
  field: contact:user.employee_id:readonly, corehr:department.cost_center_id:read, corehr:department.custom_fields:read, corehr:department.manager:read, corehr:department.organize:read
  all: contact:user.employee_id:readonly, corehr:department.cost_center_id:read, corehr:department.custom_fields:read, corehr:department.manager:read, corehr:department.organize:read, corehr:department:read, corehr:department:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/employees/additional_jobs/batch | 批量查询兼职信息
  ...
  field: contact:user.employee_id:readonly, corehr:additional_job.compensation_type:read, corehr:additional_job.compensation_type:write, corehr:additional_job.job:read, corehr:additional_job.job:write, corehr:additional_job.job_level:read, corehr:additional_job.job_level:write, corehr:additional_job.position:read, corehr:additional_job.position:write, corehr:additional_job.service_company:read, corehr:additional_job.service_company:write, corehr:additional_job.work_shift:read, corehr:additional_job.work_shift:write
  all: contact:user.employee_id:readonly, corehr:additional_job.compensation_type:read, corehr:additional_job.compensation_type:write, corehr:additional_job.job:read, corehr:additional_job.job:write, corehr:additional_job.job_level:read, corehr:additional_job.job_level:write, corehr:additional_job.position:read, corehr:additional_job.position:write, corehr:additional_job.service_company:read, corehr:additional_job.service_company:write, corehr:additional_job.work_shift:read, corehr:additional_job.work_shift:write, corehr:additional_job:read, corehr:additional_job:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/employees/batch_get | 批量查询员工信息
  required: corehr:employee:read, corehr:employee:write
  field: contact:user.employee_id:readonly, corehr:contract.period:read, corehr:contract.period:write, corehr:employee.all_bp:read, corehr:employee.bp:read, corehr:employment.archive_cpst_plan:read, corehr:employment.assignment:read, corehr:employment.assignment_pay_group:read, corehr:employment.contract_type:read, corehr:employment.custom_field:read, corehr:employment.custom_org_field:read, corehr:employment.custom_org_field:write, corehr:employment.individuals_with_headcount_or_not:read, corehr:employment.is_direct_leader:read, corehr:employment.is_dotted_leader:read, corehr:employment.job:read, corehr:employment.job_grade:read, corehr:employment.job_grade:write, corehr:employment.job_level:read, corehr:employment.job_level:write, corehr:employment.offboarding_reason:read, corehr:employment.pathway:read, corehr:employment.pathway:write, corehr:employment.pay_group:read, corehr:employment.position:read, corehr:employment.position:write, corehr:employment.seniority_adjust_information:read, corehr:employment.seniority_adjust_information:write, corehr:job.job_level:read, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read, corehr:job_data.work_shift:read, corehr:person.address:read, corehr:person.address:write, corehr:person.bank_account:read, corehr:person.bank_account:write, corehr:person.born_country_region:read, corehr:person.born_country_region:write, corehr:person.custom_field:read, corehr:person.custom_field:write, corehr:person.date_entered_workforce:read, corehr:person.date_entered_workforce:write, corehr:person.date_of_birth:read, corehr:person.date_of_birth:write, corehr:person.dependent:read, corehr:person.dependent:write, corehr:person.education:read, corehr:person.education:write, corehr:person.email:read, corehr:person.email:write, corehr:person.emergency_contact:read, corehr:person.emergency_contact:write, corehr:person.entry_leave_time:read, corehr:person.entry_leave_time:write, corehr:person.gender:read, corehr:person.gender:write, corehr:person.hukou:read, corehr:person.hukou:write, corehr:person.is_disabled:read, corehr:person.is_disabled:write, corehr:person.is_old_alone:read, corehr:person.is_old_alone:write, corehr:person.legal_name:read, corehr:person.legal_name:write, corehr:person.marital_status:read, corehr:person.marital_status:write, corehr:person.martyr_family:read, corehr:person.martyr_family:write, corehr:person.national_id:read, corehr:person.national_id:write, corehr:person.nationality:read, corehr:person.nationality:write, corehr:person.native_region:read, corehr:person.native_region:write, corehr:person.personal_profile:read, corehr:person.personal_profile:write, corehr:person.phone:read, corehr:person.phone:write, corehr:person.political_affiliation:read, corehr:person.political_affiliation:write, corehr:person.race:read, corehr:person.religion:read, corehr:person.religion:write, corehr:person.resident_tax:read, corehr:person.resident_tax:write, corehr:person.resident_tax_custom_field:read, corehr:person.resident_tax_custom_field:write, corehr:person.work_experience:read, corehr:person.work_experience:write
  all: contact:user.employee_id:readonly, corehr:contract.period:read, corehr:contract.period:write, corehr:employee.all_bp:read, corehr:employee.bp:read, corehr:employee:read, corehr:employee:write, corehr:employment.archive_cpst_plan:read, corehr:employment.assignment:read, corehr:employment.assignment_pay_group:read, corehr:employment.contract_type:read, corehr:employment.custom_field:read, corehr:employment.custom_org_field:read, corehr:employment.custom_org_field:write, corehr:employment.individuals_with_headcount_or_not:read, corehr:employment.is_direct_leader:read, corehr:employment.is_dotted_leader:read, corehr:employment.job:read, corehr:employment.job_grade:read, corehr:employment.job_grade:write, corehr:employment.job_level:read, corehr:employment.job_level:write, corehr:employment.offboarding_reason:read, corehr:employment.pathway:read, corehr:employment.pathway:write, corehr:employment.pay_group:read, corehr:employment.position:read, corehr:employment.position:write, corehr:employment.seniority_adjust_information:read, corehr:employment.seniority_adjust_information:write, corehr:job.job_level:read, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read, corehr:job_data.work_shift:read, corehr:person.address:read, corehr:person.address:write, corehr:person.bank_account:read, corehr:person.bank_account:write, corehr:person.born_country_region:read, corehr:person.born_country_region:write, corehr:person.custom_field:read, corehr:person.custom_field:write, corehr:person.date_entered_workforce:read, corehr:person.date_entered_workforce:write, corehr:person.date_of_birth:read, corehr:person.date_of_birth:write, corehr:person.dependent:read, corehr:person.dependent:write, corehr:person.education:read, corehr:person.education:write, corehr:person.email:read, corehr:person.email:write, corehr:person.emergency_contact:read, corehr:person.emergency_contact:write, corehr:person.entry_leave_time:read, corehr:person.entry_leave_time:write, corehr:person.gender:read, corehr:person.gender:write, corehr:person.hukou:read, corehr:person.hukou:write, corehr:person.is_disabled:read, corehr:person.is_disabled:write, corehr:person.is_old_alone:read, corehr:person.is_old_alone:write, corehr:person.legal_name:read, corehr:person.legal_name:write, corehr:person.marital_status:read, corehr:person.marital_status:write, corehr:person.martyr_family:read, corehr:person.martyr_family:write, corehr:person.national_id:read, corehr:person.national_id:write, corehr:person.nationality:read, corehr:person.nationality:write, corehr:person.native_region:read, corehr:person.native_region:write, corehr:person.personal_profile:read, corehr:person.personal_profile:write, corehr:person.phone:read, corehr:person.phone:write, corehr:person.political_affiliation:read, corehr:person.political_affiliation:write, corehr:person.race:read, corehr:person.religion:read, corehr:person.religion:write, corehr:person.resident_tax:read, corehr:person.resident_tax:write, corehr:person.resident_tax_custom_field:read, corehr:person.resident_tax_custom_field:write, corehr:person.work_experience:read, corehr:person.work_experience:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/employees/bps/batch_get | 查询员工 HRBP / 属地 BP
  required: corehr:employee.bp:read
  field: contact:user.employee_id:readonly, corehr:employee.all_bp:read
  all: contact:user.employee_id:readonly, corehr:employee.all_bp:read, corehr:employee.bp:read
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/employees/job_datas/batch_get | 批量查询员工任职信息
  ...
  field: contact:user.employee_id:readonly, corehr:employment.job:read, corehr:employment.job_grade:read, corehr:employment.job_grade:write, corehr:employment.job_level:read, corehr:employment.job_level:write, corehr:employment.pathway:read, corehr:employment.pathway:write, corehr:employment.position:read, corehr:employment.position:write, corehr:job_data.assignment_start_reason:read, corehr:job_data.compensation_type:read, corehr:job_data.job_data_reason:read, corehr:job_data.service_company:read, corehr:job_data.work_shift:read
  all: contact:user.employee_id:readonly, corehr:employee.job_data:read, corehr:employment.job:read, corehr:employment.job_grade:read, corehr:employment.job_grade:write, corehr:employment.job_level:read, corehr:employment.job_level:write, corehr:employment.pathway:read, corehr:employment.pathway:write, corehr:employment.position:read, corehr:employment.position:write, corehr:job_data.assignment_start_reason:read, corehr:job_data.compensation_type:read, corehr:job_data.job_data_reason:read, corehr:job_data.service_company:read, corehr:job_data.work_shift:read, corehr:job_data:read, corehr:job_data:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/enums/search | 查询枚举信息
  ...
  field: (none)
  all: corehr:common_data.meta_data:read
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/job_changes | 发起员工异动
  required: corehr:job_change:create
  field: contact:user.employee_id:readonly, corehr:contract.company:read, corehr:contract.company:write, corehr:contract.period:read, corehr:contract.period:write, corehr:employment.job:read, corehr:employment.job_grade:read, corehr:employment.job_grade:write, corehr:employment.job_level:read, corehr:employment.job_level:write, corehr:job_change.custom_field:read, corehr:job_change.employment_custom_field:read, corehr:job_change.is_adjust_salary:read, corehr:job_change.pathway:read, corehr:job_change.pathway:write, corehr:job_change.remark:read, corehr:job_change.social_security_city:read, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read
  all: contact:user.employee_id:readonly, corehr:contract.company:read, corehr:contract.company:write, corehr:contract.period:read, corehr:contract.period:write, corehr:employment.job:read, corehr:employment.job_grade:read, corehr:employment.job_grade:write, corehr:employment.job_level:read, corehr:employment.job_level:write, corehr:job_change.custom_field:read, corehr:job_change.employment_custom_field:read, corehr:job_change.is_adjust_salary:read, corehr:job_change.pathway:read, corehr:job_change.pathway:write, corehr:job_change.remark:read, corehr:job_change.social_security_city:read, corehr:job_change:create, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/job_changes/:job_change_id/revoke | 撤销异动
  required: corehr:corehr, corehr:job_change:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:corehr, corehr:job_change:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/job_changes/search | 搜索员工异动信息
  required: corehr:job_change:read, corehr:job_change:write
  field: contact:user.employee_id:readonly, corehr:contract.company:read, corehr:contract.company:write, corehr:contract.period:read, corehr:contract.period:write, corehr:employment.job:read, corehr:employment.job_grade:read, corehr:employment.job_grade:write, corehr:employment.job_level:read, corehr:employment.job_level:write, corehr:job_change.custom_field:read, corehr:job_change.employment_custom_field:read, corehr:job_change.is_adjust_salary:read, corehr:job_change.pathway:read, corehr:job_change.pathway:write, corehr:job_change.remark:read, corehr:job_change.social_security_city:read, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read
  all: contact:user.employee_id:readonly, corehr:contract.company:read, corehr:contract.company:write, corehr:contract.period:read, corehr:contract.period:write, corehr:employment.job:read, corehr:employment.job_grade:read, corehr:employment.job_grade:write, corehr:employment.job_level:read, corehr:employment.job_level:write, corehr:job_change.custom_field:read, corehr:job_change.employment_custom_field:read, corehr:job_change.is_adjust_salary:read, corehr:job_change.pathway:read, corehr:job_change.pathway:write, corehr:job_change.remark:read, corehr:job_change.social_security_city:read, corehr:job_change:read, corehr:job_change:write, corehr:job_data.compensation_type:read, corehr:job_data.service_company:read
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/job_grades/query | 查询职等
  ...
  field: (none)
  all: corehr:corehr, corehr:corehr:readonly, corehr:job_grade:read, corehr:job_grade:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/jobs/batch_get | 根据条件批量获取职务
  ...
  field: contact:user.employee_id:readonly, corehr:job.job_level:read
  all: contact:user.employee_id:readonly, corehr:job.job_level:read, corehr:job.only:read, corehr:job:read, corehr:job:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/jobs/query_multi_timeline | 查询指定时间范围职务版本
  required: corehr:job:read, corehr:job:write
  field: corehr:job.job_level:read
  all: corehr:job.job_level:read, corehr:job:read, corehr:job:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/offboardings/edit | 编辑离职信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:offboarding.update:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/offboardings/revoke | 撤销离职
  required: corehr:offboarding.revoke:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:offboarding.revoke:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/offboardings/submit_v2 | 操作员工离职
  required: corehr:offboarding.submit:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:offboarding.submit:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/pathways/batch_get | 获取通道信息
  ...
  field: (none)
  all: corehr:pathway:read, corehr:pathway:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/persons | 创建个人信息
  required: corehr:person:write
  field: corehr:person.address:read, corehr:person.address:write, corehr:person.bank_account:read, corehr:person.bank_account:write, corehr:person.born_country_region:read, corehr:person.born_country_region:write, corehr:person.custom_field:read, corehr:person.custom_field:write, corehr:person.date_entered_workforce:read, corehr:person.date_entered_workforce:write, corehr:person.date_of_birth:read, corehr:person.date_of_birth:write, corehr:person.dependent:read, corehr:person.dependent:write, corehr:person.education:read, corehr:person.education:write, corehr:person.email:read, corehr:person.email:write, corehr:person.emergency_contact:read, corehr:person.emergency_contact:write, corehr:person.entry_leave_time:read, corehr:person.entry_leave_time:write, corehr:person.gender:read, corehr:person.gender:write, corehr:person.hukou:read, corehr:person.hukou:write, corehr:person.is_disabled:read, corehr:person.is_disabled:write, corehr:person.is_old_alone:read, corehr:person.is_old_alone:write, corehr:person.legal_name:read, corehr:person.legal_name:write, corehr:person.marital_status:read, corehr:person.marital_status:write, corehr:person.martyr_family:read, corehr:person.martyr_family:write, corehr:person.national_id:read, corehr:person.national_id:write, corehr:person.nationality:read, corehr:person.nationality:write, corehr:person.native_region:read, corehr:person.native_region:write, corehr:person.passport_number:read, corehr:person.personal_profile:read, corehr:person.personal_profile:write, corehr:person.phone:read, corehr:person.phone:write, corehr:person.race:read, corehr:person.resident_tax:read, corehr:person.resident_tax:write, corehr:person.resident_tax_custom_field:read, corehr:person.resident_tax_custom_field:write, corehr:person.work_experience:read, corehr:person.work_experience:write
  all: corehr:person.address:read, corehr:person.address:write, corehr:person.bank_account:read, corehr:person.bank_account:write, corehr:person.born_country_region:read, corehr:person.born_country_region:write, corehr:person.custom_field:read, corehr:person.custom_field:write, corehr:person.date_entered_workforce:read, corehr:person.date_entered_workforce:write, corehr:person.date_of_birth:read, corehr:person.date_of_birth:write, corehr:person.dependent:read, corehr:person.dependent:write, corehr:person.education:read, corehr:person.education:write, corehr:person.email:read, corehr:person.email:write, corehr:person.emergency_contact:read, corehr:person.emergency_contact:write, corehr:person.entry_leave_time:read, corehr:person.entry_leave_time:write, corehr:person.gender:read, corehr:person.gender:write, corehr:person.hukou:read, corehr:person.hukou:write, corehr:person.is_disabled:read, corehr:person.is_disabled:write, corehr:person.is_old_alone:read, corehr:person.is_old_alone:write, corehr:person.legal_name:read, corehr:person.legal_name:write, corehr:person.marital_status:read, corehr:person.marital_status:write, corehr:person.martyr_family:read, corehr:person.martyr_family:write, corehr:person.national_id:read, corehr:person.national_id:write, corehr:person.nationality:read, corehr:person.nationality:write, corehr:person.native_region:read, corehr:person.native_region:write, corehr:person.passport_number:read, corehr:person.personal_profile:read, corehr:person.personal_profile:write, corehr:person.phone:read, corehr:person.phone:write, corehr:person.race:read, corehr:person.resident_tax:read, corehr:person.resident_tax:write, corehr:person.resident_tax_custom_field:read, corehr:person.resident_tax_custom_field:write, corehr:person.work_experience:read, corehr:person.work_experience:write, corehr:person:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/positions/query | 查询岗位信息
  required: corehr:position:read, corehr:position:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:position:read, corehr:position:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/probation/search | 搜索试用期信息
  ...
  field: contact:user.employee_id:readonly, corehr:probation.assessment:read, corehr:probation.assessment:write, corehr:probation.custom_field:read, corehr:probation.custom_field:write, corehr:probation.notes:read, corehr:probation.notes:write, corehr:probation.probation_outcome:read, corehr:probation.probation_outcome:write, corehr:probation.self_review:read, corehr:probation.self_review:write
  all: contact:user.employee_id:readonly, corehr:probation.assessment:read, corehr:probation.assessment:write, corehr:probation.custom_field:read, corehr:probation.custom_field:write, corehr:probation.notes:read, corehr:probation.notes:write, corehr:probation.probation_outcome:read, corehr:probation.probation_outcome:write, corehr:probation.self_review:read, corehr:probation.self_review:write, corehr:probation:read, corehr:probation:write
  tokens: tenant_access_token
- POST /open-apis/corehr/v2/probation/submit | 发起转正
  required: corehr:probation:write
  field: contact:user.employee_id:readonly, corehr:probation.assessment:read, corehr:probation.assessment:write, corehr:probation.custom_field:read, corehr:probation.custom_field:write, corehr:probation.notes:read, corehr:probation.notes:write, corehr:probation.self_review:read, corehr:probation.self_review:write
  all: contact:user.employee_id:readonly, corehr:probation.assessment:read, corehr:probation.assessment:write, corehr:probation.custom_field:read, corehr:probation.custom_field:write, corehr:probation.notes:read, corehr:probation.notes:write, corehr:probation.self_review:read, corehr:probation.self_review:write, corehr:probation:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/process_start | 发起流程
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, corehr:process.instance:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/report_detail_row/batchDelete | 批量删除填报行
  ...
  field: (none)
  all: corehr:workforce_plan_centralized_reporting_project_detail:write
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/signature_files/:signature_file_id/download | 下载电子签文件
  ...
  field: (none)
  all: corehr:signature_file:read
  tokens: tenant_access_token
...
- POST /open-apis/corehr/v2/workforce_plan_details/batch | 查询编制规划明细信息（不支持自定义组织）
  ...
  field: (none)
  all: corehr:workforce_detail:read
  tokens: tenant_access_token
...
- POST /open-apis/directory/v1/departments | 创建部门
  ...
  field: (none)
  all: directory:department.create:write, directory:department:write
  tokens: tenant_access_token, user_access_token
- POST /open-apis/directory/v1/departments/filter | 获取部门列表
  required: directory:department:list
  field: directory:department.base:read, directory:department.count:read, directory:department.custom_field:read, directory:department.data_source:read, directory:department.department_path:read, directory:department.external_id:read, directory:department.has_child:read, directory:department.leader:read, directory:department.name:read, directory:department.order_weight:read, directory:department.organization:read, directory:department.parent_id:read, directory:department.status:read
  all: directory:department.base:read, directory:department.count:read, directory:department.custom_field:read, directory:department.data_source:read, directory:department.department_path:read, directory:department.external_id:read, directory:department.has_child:read, directory:department.leader:read, directory:department.name:read, directory:department.order_weight:read, directory:department.organization:read, directory:department.parent_id:read, directory:department.status:read, directory:department:list
  tokens: tenant_access_token, user_access_token
- POST /open-apis/directory/v1/departments/mget | 批量获取部门信息
  required: directory:department:read
  field: directory:department.base:read, directory:department.count:read, directory:department.custom_field:read, directory:department.data_source:read, directory:department.department_path:read, directory:department.external_id:read, directory:department.has_child:read, directory:department.leader:read, directory:department.name:read, directory:department.order_weight:read, directory:department.organization:read, directory:department.parent_id:read, directory:department.status:read
  all: directory:department.base:read, directory:department.count:read, directory:department.custom_field:read, directory:department.data_source:read, directory:department.department_path:read, directory:department.external_id:read, directory:department.has_child:read, directory:department.leader:read, directory:department.name:read, directory:department.order_weight:read, directory:department.organization:read, directory:department.parent_id:read, directory:department.status:read, directory:department:read
  tokens: tenant_access_token, user_access_token
- POST /open-apis/directory/v1/departments/search | 搜索部门
  required: directory:department:search
  field: directory:department.base:read, directory:department.count:read, directory:department.custom_field:read, directory:department.data_source:read, directory:department.department_path:read, directory:department.external_id:read, directory:department.has_child:read, directory:department.leader:read, directory:department.name:read, directory:department.order_weight:read, directory:department.organization:read, directory:department.parent_id:read, directory:department.status:read
  all: directory:department.base:read, directory:department.count:read, directory:department.custom_field:read, directory:department.data_source:read, directory:department.department_path:read, directory:department.external_id:read, directory:department.has_child:read, directory:department.leader:read, directory:department.name:read, directory:department.order_weight:read, directory:department.organization:read, directory:department.parent_id:read, directory:department.status:read, directory:department:search
  tokens: tenant_access_token, user_access_token
- POST /open-apis/directory/v1/employees | 创建员工
  required: directory:employee.create:write, directory:employee:write
  field: (none)
  all: directory:employee.create:write, directory:employee:write
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/document_ai/v1/food_manage_license/recognize | 识别文件中的食品经营许可证
  ...
  field: (none)
  all: document_ai:food_manage_license:recognize
  tokens: tenant_access_token
...
- POST /open-apis/docx/v1/documents | 创建文档
  ...
  field: (none)
  all: docx:document, docx:document:create
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/drive/v1/files/:file_token/copy | 复制文件
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, docs:document:copy, drive:drive
  tokens: tenant_access_token, user_access_token
- POST /open-apis/drive/v1/files/:file_token/move | 移动文件或文件夹
  required: drive:drive, space:document:move
  field: (none)
  all: drive:drive, space:document:move
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/drive/v1/import_tasks | 创建导入任务
  ...
  field: (none)
  all: docs:document:import, drive:drive
  tokens: tenant_access_token, user_access_token
- POST /open-apis/drive/v1/medias/upload_all | 上传素材
  ...
  field: (none)
  all: bitable:app, docs:doc, docs:document.media:upload, drive:drive, moments:moments, sheets:spreadsheet, vc:material
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/drive/v1/metas/batch_query | 获取文件元数据
  ...
  field: contact:user.employee_id:readonly, drive:file.meta.sec_label.read_only
  all: contact:user.employee_id:readonly, drive:drive, drive:drive.metadata:readonly, drive:file.meta.sec_label.read_only
  tokens: tenant_access_token, user_access_token
- POST /open-apis/drive/v1/permissions/:token/members | 增加协作者权限
  ...
  field: (none)
  all: bitable:app, bitable:bitable, docs:doc, docs:permission.member:create, drive:drive, drive:file, sheets:spreadsheet, wiki:wiki
  tokens: tenant_access_token, user_access_token
- POST /open-apis/drive/v1/permissions/:token/members/batch_create | 批量增加协作者权限
  ...
  field: (none)
  all: docs:permission.member, docs:permission.member:create
  tokens: tenant_access_token, user_access_token
- POST /open-apis/drive/v1/permissions/:token/members/transfer_owner | 转移云文档所有者
  ...
  field: (none)
  all: bitable:app, bitable:bitable, docs:doc, docs:permission.member:transfer, drive:drive, sheets:spreadsheet, wiki:wiki
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/hire/v1/advertisements/:advertisement_id/publish | 发布职位广告
  ...
  field: (none)
  all: hire:advertisement
  tokens: tenant_access_token
- POST /open-apis/hire/v1/agencies/batch_query | 搜索猎头供应商列表
  required: hire:agency, hire:agency:readonly
  field: contact:user.employee_id:readonly, hire:agency.email:readonly
  all: contact:user.employee_id:readonly, hire:agency, hire:agency.email:readonly, hire:agency:readonly
  tokens: tenant_access_token
- POST /open-apis/hire/v1/agencies/get_agency_account | 查询猎头供应商下猎头列表
  required: hire:agency_account, hire:agency_account:readonly
  field: hire:agency.email:readonly, hire:agency.mobile:readonly
  all: hire:agency.email:readonly, hire:agency.mobile:readonly, hire:agency_account, hire:agency_account:readonly
  tokens: tenant_access_token
- POST /open-apis/hire/v1/agencies/operate_agency_account | 禁用/取消禁用猎头
  required: hire:agency_account
  field: (none)
  all: hire:agency_account
  tokens: tenant_access_token
...
- POST /open-apis/hire/v1/background_check_orders/batch_query | 查询背调信息列表
  required: hire:background_check_order, hire:background_check_order:readonly
  field: contact:user.employee_id:readonly, hire:employee.email:readonly, hire:employee.mobile:readonly, hire:talent.email:readonly, hire:talent.mobile:readonly
  all: contact:user.employee_id:readonly, hire:background_check_order, hire:background_check_order:readonly, hire:employee.email:readonly, hire:employee.mobile:readonly, hire:talent.email:readonly, hire:talent.mobile:readonly
  tokens: tenant_access_token
...
- POST /open-apis/hire/v1/eco_exams/:exam_id/login_info | 回传笔试安排结果
  ...
  field: (none)
  all: hire:exam, hire:exam:readonly
  tokens: tenant_access_token
...
- POST /open-apis/hire/v1/exams | 添加笔试结果
  required: hire:exam
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:exam
  tokens: tenant_access_token
...
- POST /open-apis/hire/v1/external_background_checks/batch_query | 查询外部背调列表
  ...
  field: (none)
  all: hire:external_application, hire:external_application:readonly
  tokens: tenant_access_token
...
- POST /open-apis/hire/v1/external_offers/batch_query | 查询外部 Offer 列表
  ...
  field: (none)
  all: hire:external_offer, hire:external_offer:readonly
  tokens: tenant_access_token
- POST /open-apis/hire/v1/external_referral_rewards | 导入外部内推奖励
  required: hire:external_referral_reward
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:external_referral_reward
  tokens: tenant_access_token
- POST /open-apis/hire/v1/job_publish_records/search | 获取职位广告发布记录
  required: hire:job, hire:job:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:job, hire:job:readonly
  tokens: tenant_access_token
- POST /open-apis/hire/v1/job_requirements | 创建招聘需求
  required: hire:job_requirement
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:job_requirement
  tokens: tenant_access_token
...
- POST /open-apis/hire/v1/jobs/:job_id/combined_update | 更新职位
  required: hire:job
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:job
  tokens: tenant_access_token
...
- POST /open-apis/hire/v1/offers | 创建 Offer
  required: hire:offer
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:offer
  tokens: tenant_access_token
...
- POST /open-apis/hire/v1/referral_account | 注册内推账户
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:referral_account
  tokens: tenant_access_token
...
- POST /open-apis/hire/v1/talents/add_to_folder | 将人才加入指定文件夹
  ...
  field: (none)
  all: hire:talent, hire:talent_folder_association
  tokens: tenant_access_token
- POST /open-apis/hire/v1/talents/batch_get_id | 批量获取人才ID
  required: hire:talent, hire:talent:readonly
  field: hire:talent_onboard_status:readonly
  all: hire:talent, hire:talent:readonly, hire:talent_onboard_status:readonly
  tokens: tenant_access_token
- POST /open-apis/hire/v1/talents/combined_create | 创建人才
  required: hire:talent
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:talent
  tokens: tenant_access_token
...
- POST /open-apis/hire/v1/talents/remove_to_folder | 将人才从指定文件夹移除
  ...
  field: (none)
  all: hire:talent_folder_association
  tokens: tenant_access_token
- POST /open-apis/hire/v1/tests/search | 获取笔试列表
  required: hire:exam, hire:exam:readonly
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:exam, hire:exam:readonly
  tokens: tenant_access_token
...
- POST /open-apis/hire/v1/websites/:website_id/deliveries/create_by_attachment | 根据简历附件创建招聘官网投递任务
  ...
  field: (none)
  all: hire:site_application
  tokens: tenant_access_token
- POST /open-apis/hire/v1/websites/:website_id/deliveries/create_by_resume | 新建招聘官网投递
  required: hire:site_application
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, hire:site_application
  tokens: tenant_access_token
...
- POST /open-apis/human_authentication/v1/identities | 录入身份信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, human_authentication:identity
  tokens: tenant_access_token
- POST /open-apis/im/v1/chats | 创建群
  required: im:chat, im:chat:create, im:chat:create_by_user
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, im:chat, im:chat:create, im:chat:create_by_user
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/im/v1/chats/:chat_id/link | 获取群分享链接
  required: im:chat, im:chat:read, im:chat:readonly
  field: (none)
  all: im:chat, im:chat:read, im:chat:readonly
  tokens: tenant_access_token, user_access_token
- POST /open-apis/im/v1/chats/:chat_id/managers/add_managers | 指定群管理员
  required: im:chat, im:chat.managers:write_only
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, im:chat, im:chat.managers:write_only
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/im/v1/chats/:chat_id/top_notice/delete_top_notice | 撤销群置顶
  ...
  field: (none)
  all: im:chat, im:chat.top_notice:write_only
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/im/v1/files | 上传文件
  ...
  field: (none)
  all: im:resource, im:resource:upload
  tokens: tenant_access_token
...
- POST /open-apis/im/v1/messages | 发送消息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, im:message, im:message:send, im:message:send_as_bot
  tokens: tenant_access_token
- POST /open-apis/im/v1/messages/:message_id/forward | 转发消息
  required: im:message, im:message:send_as_bot
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, im:message, im:message:send_as_bot
  tokens: tenant_access_token
- POST /open-apis/im/v1/messages/:message_id/push_follow_up | 添加跟随气泡
  required: im:message, im:message:send_as_bot
  field: (none)
  all: im:message, im:message:send_as_bot
  tokens: tenant_access_token
...
- POST /open-apis/im/v1/messages/:message_id/reply | 回复消息
  required: im:message, im:message:send, im:message:send_as_bot
  field: (none)
  all: im:message, im:message:send, im:message:send_as_bot
  tokens: tenant_access_token
...
- POST /open-apis/im/v2/biz_entity_tag_relation | 绑定标签到群
  ...
  field: (none)
  all: im:biz_entity_tag_relation:write
  tokens: tenant_access_token
...
- POST /open-apis/mail/v1/mailgroups/:mailgroup_id/managers/batch_create | 批量创建邮件组管理员
  required: mail:mailgroup
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, mail:mailgroup
  tokens: tenant_access_token
...
- POST /open-apis/mail/v1/public_mailboxes | 创建公共邮箱
  required: mail:public_mailbox
  field: mail:public_mailbox.public_mailbox_geo
  all: mail:public_mailbox, mail:public_mailbox.public_mailbox_geo
  tokens: tenant_access_token
...
- POST /open-apis/mail/v1/public_mailboxes/:public_mailbox_id/members | 添加公共邮箱成员
  required: mail:public_mailbox
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, mail:public_mailbox
  tokens: tenant_access_token
...
- POST /open-apis/mail/v1/user_mailboxes/:user_mailbox_id/mail_contacts | 创建邮箱联系人
  required: mail:user_mailbox.mail_contact:write
  field: mail:user_mailbox.mail_contact.mail_address:read, mail:user_mailbox.mail_contact.phone:read
  all: mail:user_mailbox.mail_contact.mail_address:read, mail:user_mailbox.mail_contact.phone:read, mail:user_mailbox.mail_contact:write
  tokens: tenant_access_token, user_access_token
- POST /open-apis/mail/v1/user_mailboxes/:user_mailbox_id/messages/send | 发送邮件
  required: mail:user_mailbox.message:send
  field: (none)
  all: mail:user_mailbox.message:send
  tokens: user_access_token
...
- POST /open-apis/mdm/v1/user_auth_data_relations/bind | 用户数据维度绑定
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, mdm:user_auth
  tokens: tenant_access_token
...
- POST /open-apis/okr/v1/images/upload | 上传进展记录图片
  ...
  field: (none)
  all: okr:okr, okr:okr.progress.file:upload
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/performance/v2/activity/query | 获取项目列表
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, performance:performance, performance:performance:readonly, performance:semester_activity:read
  tokens: tenant_access_token
...
- POST /open-apis/performance/v2/additional_informations/query | 批量查询补充信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, performance:performance, performance:performance:readonly, performance:semester_activity:read, performance:semester_activity:write
  tokens: tenant_access_token
- POST /open-apis/performance/v2/indicators/query | 获取评估项列表
  ...
  field: (none)
  all: performance:performance, performance:performance:readonly, performance:review_template:read
  tokens: tenant_access_token
- POST /open-apis/performance/v2/metric_details/import | 录入被评估人关键指标数据
  required: performance:metric:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, performance:metric:write
  tokens: tenant_access_token
- POST /open-apis/performance/v2/metric_details/query | 获取被评估人关键指标结果
  required: performance:metric:read, performance:metric:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, performance:metric:read, performance:metric:write
  tokens: tenant_access_token
...
- POST /open-apis/performance/v2/metric_libs/query | 获取指标列表
  required: performance:metric:read, performance:metric:write, performance:metric_lib:read
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, performance:metric:read, performance:metric:write, performance:metric_lib:read
  tokens: tenant_access_token
...
- POST /open-apis/performance/v2/reviewees/query | 获取被评估人信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, performance:performance, performance:performance:readonly, performance:semester_user:read
  tokens: tenant_access_token
- POST /open-apis/performance/v2/user_group_user_rels/write | 更新人员组成员
  required: performance:semester_activity:write
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, performance:semester_activity:write
  tokens: tenant_access_token
- POST /open-apis/performance/v2/user_info/query | 获取绩效周期的人员信息
  required: performance:performance, performance:performance:readonly
  field: contact:user.employee_id:readonly, performance:user_snapshot.department:read, performance:user_snapshot.direct_leader:read, performance:user_snapshot.job_family:read, performance:user_snapshot.job_level:read
  all: contact:user.employee_id:readonly, performance:performance, performance:performance:readonly, performance:user_snapshot.department:read, performance:user_snapshot.direct_leader:read, performance:user_snapshot.job_family:read, performance:user_snapshot.job_level:read
  tokens: tenant_access_token
...
- POST /open-apis/personal_settings/v1/system_statuses/:system_status_id/batch_close | 批量关闭系统状态
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, personal_settings:status:system_status_operate
  tokens: tenant_access_token
...
- POST /open-apis/search/v2/schemas | 创建数据范式
  ...
  field: (none)
  all: search:data_schemas:create, search:data_source, search:data_source:readonly
  tokens: tenant_access_token
- POST /open-apis/security_and_compliance/v1/openapi_logs/list_data | 获取OpenAPI审计日志数据
  ...
  field: (none)
  all: security_and_compliance:audit_log.openapi_log:readonly
  tokens: tenant_access_token
- POST /open-apis/security_and_compliance/v1/user_migrations | 迁移用户
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, security_and_compliance:user_migration, security_and_compliance:user_migration:multi-geo
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/sheets/v3/spreadsheets | 创建电子表格
  ...
  field: (none)
  all: drive:drive, sheets:spreadsheet, sheets:spreadsheet:create
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/spark/v1/apps/:app_id/sql_commands | 执行 SQL
  ...
  field: (none)
  all: spark:app.sql_commands:write
  tokens: user_access_token
...
- POST /open-apis/task/v1/tasks/:task_id/batch_delete_collaborator | 批量删除执行者
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, task:personnel:writeonly, task:task
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/task/v2/attachments/upload | 上传附件
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, task:attachment:upload, task:attachment:write
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/task/v2/custom_fields/:custom_field_guid/add | 将自定义字段加入资源
  required: task:custom_field:write, task:custom_field:writeonly
  field: (none)
  all: task:custom_field:write, task:custom_field:writeonly
  tokens: tenant_access_token, user_access_token
- POST /open-apis/task/v2/custom_fields/:custom_field_guid/options | 创建自定义任务选项
  ...
  field: (none)
  all: task:custom_field:writeonly, task:tasklist:read, task:tasklist:write
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/task/v2/tasks/:task_guid/add_members | 添加任务成员
  ...
  field: (none)
  all: task:personnel:writeonly, task:task:write
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/vc/v1/exports/meeting_list | 导出会议明细
  required: vc:export, vc:meeting:export
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:export, vc:meeting:export
  tokens: tenant_access_token, user_access_token
...
- POST /open-apis/vc/v1/meetings/search | 搜索会议记录
  ...
  field: (none)
  all: vc:meeting.search:read
  tokens: user_access_token
- POST /open-apis/vc/v1/reserves/apply | 预约会议
  required: vc:reserve
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:reserve
  tokens: tenant_access_token, user_access_token
- POST /open-apis/vc/v1/room_configs/set | 设置会议室配置
  required: vc:room
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:room
  tokens: tenant_access_token
...
- POST /open-apis/vc/v1/rooms | 创建会议室
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, vc:room, vc:rooms.room:create
  tokens: tenant_access_token
...
- PUT /open-apis/application/v6/applications/:app_id/collaborators | 更新应用协作者
  ...
  field: contact:user.employee_id:readonly
  all: application:application.collaborators:write, contact:user.employee_id:readonly
  tokens: tenant_access_token, user_access_token
- PUT /open-apis/application/v6/applications/:app_id/management | 启停用应用
  required: admin:app.enable:write
  field: (none)
  all: admin:app.enable:write
  tokens: tenant_access_token
...
- PUT /open-apis/bitable/v1/apps/:app_token/workflows/:workflow_id | 更新自动化流程状态
  ...
  field: (none)
  all: base:workflow:write, bitable:app
  tokens: tenant_access_token, user_access_token
...
- PUT /open-apis/contact/v3/departments/:department_id | 更新部门所有信息
  required: contact:contact
  field: contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:department.base:readonly, contact:department.organize:readonly, contact:user.employee_id:readonly
  all: contact:contact, contact:contact:access_as_app, contact:contact:readonly, contact:contact:readonly_as_app, contact:department.base:readonly, contact:department.organize:readonly, contact:user.employee_id:readonly
  tokens: tenant_access_token
...
- PUT /open-apis/drive/v1/permissions/:token/members/:member_id | 更新协作者权限
  ...
  field: (none)
  all: bitable:app, bitable:bitable, docs:doc, docs:permission.member:update, drive:drive, drive:file, sheets:spreadsheet, wiki:wiki
  tokens: tenant_access_token, user_access_token
...
- PUT /open-apis/hire/v1/offer_custom_fields/:offer_custom_field_id | 更新 Offer 申请表自定义字段
  ...
  field: (none)
  all: hire:offer_selection_object
  tokens: tenant_access_token
...
- PUT /open-apis/im/v1/chats/:chat_id | 更新群信息
  ...
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, im:chat, im:chat:update
  tokens: tenant_access_token, user_access_token
- PUT /open-apis/im/v1/chats/:chat_id/moderation | 更新群发言权限
  required: im:chat, im:chat:moderation:write_only
  field: contact:user.employee_id:readonly
  all: contact:user.employee_id:readonly, im:chat, im:chat:moderation:write_only
  tokens: tenant_access_token, user_access_token
...
- PUT /open-apis/security_and_compliance/v2/device_apply_records/:device_apply_record_id | 审批设备申报
  ...
  field: (none)
  all: security_and_compliance:device_apply_record:write
  tokens: tenant_access_token
...
- PUT /open-apis/wiki/v2/spaces/:space_id/setting | 更新知识空间设置
  ...
  field: (none)
  all: wiki:setting:write_only, wiki:wiki
  tokens: tenant_access_token, user_access_token
